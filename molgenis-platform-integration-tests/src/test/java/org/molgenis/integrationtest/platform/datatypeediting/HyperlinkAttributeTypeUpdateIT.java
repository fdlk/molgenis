...
public class HyperlinkAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  /**
   * Valid conversion cases for HYPERLINK to: STRING, TEXT, CATEGORICAL, XREF
   *
  ...
  /**
   * Invalid conversions cases for HYPERLINK to: BOOL, INT, LONG, DECIMAL, XREF, CATEGORICAL,
   * SCRIPT, EMAIL, HTML, ENUM, DATE, DATE_TIME, MREF, CATEGORICAL_MREF, FILE, COMPOUND, ONE_TO_MANY
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
