 ...
 *
 * <p>If No JSESSIONID is provided it session is valid.
 *
 * <p>If session is invalid a 401 is returned to the client.
 *
 * <p>Because the REST api doesn't need authentication this Filter must be used in addition to the
...
public class ApiSessionExpirationFilter extends GenericFilterBean {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    if (!SecurityUtils.currentUserIsAuthenticated()
      ...
      httpRequest
          .getSession()
          .setAttribute(MolgenisLoginController.SESSION_EXPIRED_SESSION_ATTRIBUTE, true);
    }
