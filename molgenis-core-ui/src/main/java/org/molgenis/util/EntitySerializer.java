...
/**
 * Serializer for concrete Entity subclasses. This allows you to return Entities in your
 * Controllers, without having to create DTO's with explicit fields for {@link Gson} serialization.
 */
      ...
      if (value != null) {
        ...
        switch (attrType) {
          ...
          case ONE_TO_MANY:
            ...
            entity
                .getEntities(attributeName)
                .forEach(e -> jsonArray.add(serializeReference(e, context)));
