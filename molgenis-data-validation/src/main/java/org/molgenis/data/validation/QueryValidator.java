...
/**
 * Validates {@link Query queries} based on the {@link EntityType entity type} that will be queried.
 * Converts query values to the correct class type if possible.
 *
 * @see <a
        ...
        throw new MolgenisValidationException(
            new ConstraintViolation(
                format(
                    ...
                    attr.getName(), value, Long.class.getSimpleName())));
      }
