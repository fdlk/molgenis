...
public class DateTimeAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  public Object[][] validConversionTestCases() {
    ...
    String formattedInDefaultTimezone =
        value
            .atZone(ZoneId.systemDefault())
            .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ssx"));
    return new Object[][] {
      {value, STRING, formattedInDefaultTimezone},
      {value, TEXT, formattedInDefaultTimezone},
      {value, DATE, "2016-11-13"}
    };
  }

  /**
   * Valid conversion cases for DATE_TIME to: STRING, TEXT, DATE
   *
  ...
  public void testValidConversion(
      Instant valueToConvert, AttributeType typeToConvertTo, Object convertedValue)
  ...
  /**
   * Invalid conversion cases for DATE_TIME to: BOOL, INT, LONG, DECIMAL, XREF, CATEGORICAL, SCRIPT,
   * HYPERLINK, EMAIL, ENUM, HTML, MREF, CATEGORICAL_MREF, FILE, COMPOUND, ONE_TO_MANY
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
