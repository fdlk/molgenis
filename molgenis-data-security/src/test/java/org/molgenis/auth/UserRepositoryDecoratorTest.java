...
public class UserRepositoryDecoratorTest {
  ...
  public void setUp() {
    ...
    when(dataService.getRepository(USER_AUTHORITY, UserAuthority.class))
        .thenReturn(userAuthorityRepository);
    when(dataService.getRepository(GROUP_MEMBER, GroupMember.class))
        .thenReturn(groupMemberRepository);
    passwordEncoder = mock(PasswordEncoder.class);
    userRepositoryDecorator =
        new UserRepositoryDecorator(
            delegateRepository, userAuthorityFactory, dataService, passwordEncoder);
  }
