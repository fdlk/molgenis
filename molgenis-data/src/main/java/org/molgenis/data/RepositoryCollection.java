...
public interface RepositoryCollection extends Iterable<Repository<Entity>> {
  ...
  /**
   * Creates a new {@link Repository} within this repository collection for the given entity meta
   * data.
   *
   * @param entityType entity meta data
   * @return the created repository
   * @throws UnsupportedOperationException if this repository collection is not {@link
   *     RepositoryCollectionCapability#WRITABLE}
   */
   ...
   *
   * @param entityType@throws UnsupportedOperationException if this repository collection is not
   *     {@link RepositoryCollectionCapability#WRITABLE}
   */
  void deleteRepository(EntityType entityType);

  /**
   * Updates a repository. Handles EntityType changes other than the addition/alteration/removal of
   * attributes.
   *
   ...
   * @throws UnsupportedOperationException if this repository collection is not {@link
   *     RepositoryCollectionCapability#UPDATABLE}
   */
