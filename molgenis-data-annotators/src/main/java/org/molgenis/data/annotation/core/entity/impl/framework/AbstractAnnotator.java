...
/**
 * The most standard implementation of an {@link EntityAnnotator} that first creates a query,
 * queries the resource, then filters the results using a {@link ResultFilter} and then copies the
 * resulting attributes to the annotated {@link Entity}.
 */
public abstract class AbstractAnnotator extends QueryAnnotatorImpl implements EntityAnnotator {
  ...
  protected void processQueryResults(
    ...
    Optional<Entity> filteredResult =
        resultFilter.filterResults(annotationSourceEntities, entity, updateMode);
