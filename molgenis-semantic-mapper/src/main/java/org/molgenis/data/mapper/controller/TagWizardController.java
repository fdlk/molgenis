...
public class TagWizardController extends PluginController {
  ...
  @ResponseBody
  public void deleteSingleTag(@Valid @RequestBody RemoveTagRequest request) {
  ...
  @ResponseBody
  public void clearAllTags(@RequestParam String entityTypeId) {
  ...
  @ResponseBody
  public Map<String, OntologyTag> autoTagAttributes(@Valid @RequestBody AutoTagRequest request) {
    Map<Attribute, Hit<OntologyTerm>> autoGeneratedTags =
        semanticSearchService.findTags(request.getEntityTypeId(), request.getOntologyIds());
