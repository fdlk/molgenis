...
public class DannAnnotator implements AnnotatorConfig {
  ...
  @Autowired private Entity dannAnnotatorSettings;
    ...
    EntityAnnotator entityAnnotator =
        new AbstractAnnotator(
            ...
            new SingleFileLocationCmdLineAnnotatorSettingsConfigurer(
                DANN_LOCATION, dannAnnotatorSettings)) {
          @Override
  ...
  Resource dannResource() {
    ...
    dannTabixResource =
        new ResourceImpl(
            DANN_TABIX_RESOURCE, new SingleResourceConfig(DANN_LOCATION, dannAnnotatorSettings)) {
          @Override
