...
public class StyleServiceImpl implements StyleService {
  ...
  public Set<Style> getAvailableStyles() {
    Stream<StyleSheet> styleEntities =
        dataService.findAll(StyleMetadata.STYLE_SHEET, StyleSheet.class);
  ...
  public Style addStyle(
    ...
    FileMeta bootstrap3ThemeFileMeta =
        createStyleSheetFileMeta(bootstrap3FileName, bootstrap3StyleData);
    ...
    if (bootstrap4FileName != null && bootstrap4StyleData != null) {
      FileMeta bootstrap4ThemeFileMeta =
          createStyleSheetFileMeta(bootstrap4FileName, bootstrap4StyleData);
