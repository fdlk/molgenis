...
public class LocalizationServiceTest extends AbstractMolgenisSpringTest {
  ...
  @Mock private L10nString string1;
  @Mock private L10nString string2;
  ...
  public void testGetMessage() throws Exception {
    Query<L10nString> query =
        new QueryImpl<L10nString>().eq(MSGID, "EN_PLUS_NL").and().eq(NAMESPACE, "test");
  ...
  public void testGetMessages() throws Exception {
    ...
    when(dataService.findAll(L10N_STRING, query, L10nString.class))
        .thenAnswer((i) -> Stream.of(string1, string2));

    assertEquals(
        localizationService.getMessages("test", "nl"),
  ...
  public void testPopulateLocalizationStrings() throws Exception {
    Query<L10nString> query =
        new QueryImpl<L10nString>()
            .in(MSGID, asList("EN_PLUS_NL", "EN_ONLY", "NL_ONLY", "BIOBANK_UTF8"))
            .and()
            .eq(NAMESPACE, "test");
    when(dataService.findAll(L10N_STRING, query, L10nString.class))
        .thenReturn(Stream.of(string1, string2));
  ...
  public void testAddMissingMessageIDs() throws Exception {
    Query<L10nString> query =
        new QueryImpl<L10nString>()
            .in(MSGID, asList("EN_PLUS_NL", "NEW"))
            .and()
            .eq(NAMESPACE, "test");
  ...
  public void testDeleteNamespace() {
    ...
    assertEquals(
        deleteCaptor.getValue().collect(Collectors.toList()), newArrayList(string1, string2));
  }
