...
public class ThousandGenomesAnnotator implements AnnotatorConfig {
  ...
  @Autowired private Entity thousendGenomesAnnotatorSettings;
    ...
    MultiAllelicResultFilter multiAllelicResultFilter =
        new MultiAllelicResultFilter(
            singletonList(
                attributeFactory
                    .create()
                    .setName(THOUSAND_GENOME_AF_RESOURCE_ATTRIBUTE_NAME)
                    .setDataType(DECIMAL)),
            vcfAttributes);
    ...
    EntityAnnotator entityAnnotator =
        new AbstractAnnotator(
            ...
            (annotationSourceFileName) -> {
              ...
              thousendGenomesAnnotatorSettings.set(
                  FILEPATTERN,
          ...
          protected Object getResourceAttributeValue(Attribute attr, Entity entityType) {
            String attrName =
                THOUSAND_GENOME_AF.equals(attr.getName())
  ...
  Resource thousandGenomesSources() {
    MultiResourceConfig thousandGenomeConfig =
