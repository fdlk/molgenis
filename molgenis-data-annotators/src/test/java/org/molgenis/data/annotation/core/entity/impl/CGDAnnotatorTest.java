...
public class CGDAnnotatorTest extends AbstractMolgenisSpringTest {
  ...
  public void annotateTestMatch() {
    ...
    assertEquals(
        resultEntity.get(MANIFESTATION_CATEGORIES.getAttributeName()),
        "Allergy/Immunology/Infectious; Endocrine");
    assertEquals(
        resultEntity.get(INTERVENTION_CATEGORIES.getAttributeName()),
        "Allergy/Immunology/Infectious; Endocrine");
    assertEquals(
        resultEntity.get(COMMENTS.getAttributeName()),
        "Standard treatments for obesity, such as gastric surgery, have been described as beneficial");
    assertEquals(
        resultEntity.get(INTERVENTION_RATIONALE.getAttributeName()),
    ...
    assertEquals(
        resultEntity.get(REFERENCES.getAttributeName()),
