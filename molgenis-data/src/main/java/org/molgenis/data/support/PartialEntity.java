...
/**
 * Entity with partially loaded attributes based on a fetch. Requesting attributes not included in
 * the fetch are retrieved on demand.
 */
  ...
  public <E extends Entity> E getEntity(String attributeName, Class<E> clazz) {
    if (fetch.hasField(attributeName)) {
      ...
      return entityManager
          .getReference(getEntityType(), getIdValue())
