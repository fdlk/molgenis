...
public class EntityTypeValidatorTest {
  ...
  private EntityType entityType =
      when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
  ...
  @Test(
    ...
    expectedExceptionsMessageRegExp = "Label of EntityType \\[package_name\\] is empty"
  )
  ...
  @Test(
    ...
    expectedExceptionsMessageRegExp =
        "Label of EntityType \\[package_name\\] contains only white space"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "An attribute with name \\[idAttr\\] already exists in entity \\[extendsEntity\\] or one of its parents"
  )
  public void testValidateAttributeOwnedByExtendedEntity() {
    EntityType extendsEntityType =
        when(mock(EntityType.class).getId()).thenReturn("extendsEntity").getMock();
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Entity \\[package_name\\] ID attribute \\[idAttr\\] is not part of the entity attributes"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Entity \\[package_name\\] ID attribute \\[idAttr\\] type \\[XREF\\] is not allowed"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Entity \\[package_name\\] ID attribute \\[idAttr\\] is not a unique attribute"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Entity \\[package_name\\] ID attribute \\[idAttr\\] is not a non-nillable attribute"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp = "Entity \\[package_name\\] is missing required ID attribute"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Label attribute \\[labelAttr\\] is not part of the entity attributes"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Lookup attribute \\[labelAttr\\] is not part of the entity attributes"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp = "Unknown backend \\[invalidBackend\\]"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "EntityType \\[concreteEntity\\] is not abstract; EntityType \\[package_name\\] can't extend it"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Adding entity \\[myEntity\\] to system package \\[sys\\] is not allowed"
  )
  ...
  @Test(
    expectedExceptions = MolgenisValidationException.class,
    expectedExceptionsMessageRegExp =
        "Entity \\[package_name\\] contains multiple attributes with name \\[idAttr\\]"
  )
