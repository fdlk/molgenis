...
public class GoogleSpreadsheetRepositoryTest extends AbstractMolgenisSpringTest {
  ...
  public void setUp() throws IOException, ServiceException {
    ...
    when(customElements.getTags())
        .thenReturn(new LinkedHashSet<>(Arrays.asList("col1", "col2", "col3")));
    ...
    spreadsheetRepository =
        new GoogleSpreadsheetRepository(
            spreadsheetService, "key", "id", entityTypeFactory, attrMetaFactory);
  }

  @Test(expectedExceptions = NullPointerException.class)
  public void GoogleSpreadsheetRepository() throws IOException, ServiceException {
    try (GoogleSpreadsheetRepository repo =
        new GoogleSpreadsheetRepository(null, null, null, null, null)) {}
  }
