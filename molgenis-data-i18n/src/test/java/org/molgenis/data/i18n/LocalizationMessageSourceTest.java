...
public class LocalizationMessageSourceTest {
  ...
  public void setUp() throws Exception {
    initMocks(this);
    when(localizationService.getMessage("my-namespace", "TEST_MESSAGE_DE", "de"))
        .thenReturn("Deutsche Nachricht");
    when(localizationService.getMessage("my-namespace", "TEST_MESSAGE_NL", "nl"))
        .thenReturn("Nederlands bericht");
    when(localizationService.getMessage("my-namespace", "TEST_MESSAGE_EN", "en"))
        .thenReturn("English message");
    this.localizationMessageSource =
        new LocalizationMessageSource(localizationService, "my-namespace", appSettings);
  }
  ...
  public void testResolveCodeWithoutArgumentsMessageFoundForCode() throws Exception {
    assertEquals(
        localizationMessageSource.resolveCodeWithoutArguments("TEST_MESSAGE_DE", Locale.GERMAN),
        "Deutsche Nachricht");
  }
  ...
  public void testResolveCodeWithoutArgumentsMessageFoundForAppDefaultLanguage() throws Exception {
    ...
    assertEquals(
        localizationMessageSource.resolveCodeWithoutArguments("TEST_MESSAGE_NL", new Locale("nl")),
        "Nederlands bericht");
  }
  ...
  public void testResolveCodeWithoutArgumentsMessageFoundForDefaultLanguage() throws Exception {
    assertEquals(
        localizationMessageSource.resolveCodeWithoutArguments("TEST_MESSAGE_EN", new Locale("en")),
        "English message");
  }
