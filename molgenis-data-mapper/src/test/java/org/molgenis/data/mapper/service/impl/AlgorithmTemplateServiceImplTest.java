...
public class AlgorithmTemplateServiceImplTest extends AbstractMolgenisSpringTest
{
	...
	public void find()
	{
		...
		ExplainedQueryString sourceAttr0Explain = ExplainedQueryString.create("b", param0Name, param0Name, 1.0f);
		ExplainedQueryString sourceAttr1Explain = ExplainedQueryString.create("b", param1Name, param1Name, 0.5f);
