...
public class CacheFactory {
  ...
  /**
   * Creates a {@link LoadingCache} for a {@link FunctionalInterface} that may throw a {@link
   * RemoteException}
   *
   ...
   * @param pathwayTransformer {@link Function} that transforms the loaded pathways to {@link
   *     Pathway}s
