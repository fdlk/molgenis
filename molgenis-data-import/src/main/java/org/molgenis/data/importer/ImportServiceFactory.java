...
public class ImportServiceFactory {
   ...
   *
   * <p>Import of mixed backend types in one FileRepositoryCollection isn't supported.
   *
   * @return ImportService
   * @throws MolgenisDataException if no suitable ImportService is found for the
  ...
  public ImportService getImportService(File file, RepositoryCollection source) {
    ...
    String extension =
        FileExtensionUtils.findExtensionFromPossibilities(
            file.getName(), importServicesMappedToExtensions.keySet());
  ...
  public ImportService getImportService(String fileName) {
    ...
    String extension =
        FileExtensionUtils.findExtensionFromPossibilities(
            fileName, importServicesMappedToExtensions.keySet());
