...
public class XmlMolgenisUiPluginTest {
  ...
  public void getId() {
    ...
    XmlMolgenisUiPlugin xmlMolgenisUiPlugin =
        new XmlMolgenisUiPlugin(pluginType, molgenisUiMenu, permissionService);
  ...
  public void getType() {
    XmlMolgenisUiPlugin xmlMolgenisUiPlugin =
        new XmlMolgenisUiPlugin(new PluginType(), molgenisUiMenu, permissionService);
