...
public class EnumAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  /**
   * Valid conversion cases for ENUM to: STRING, TEXT, INT, LONG
   *
  ...
  /**
   * Invalid conversions cases for ENUM to: INT, LONG, DECIMAL, XREF, CATEGORICAL, DATE, DATE_TIME,
   * MREF, CATEGORICAL_MREF, EMAIL, HTML, HYPERLINK, COMPOUND, FILE, BOOL, STRING, SCRIPT,
   * ONE_TO_MANY
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
