...
public class GavinAnnotatorTest extends AbstractMolgenisSpringTest {
  ...
  public void beforeClass() throws IOException {
    ...
    List<Attribute> refAttributesList =
        Arrays.asList(
            CaddAnnotator.createCaddScaledAttr(attributeFactory),
            ExacAnnotator.getExacAFAttr(attributeFactory),
  ...
  private Entity getEffectEntity(
      String alt, String putativeImpact, String geneName, Entity variantEntity) {
