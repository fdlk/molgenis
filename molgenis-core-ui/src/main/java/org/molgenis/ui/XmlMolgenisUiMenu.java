...
public class XmlMolgenisUiMenu implements UiMenu {
  ...
  public XmlMolgenisUiMenu(
      MenuType menuType, UiMenu parentMenu, PermissionService permissionService) {
  ...
  public List<UiMenu> getBreadcrumb() {
    ...
    for (UiMenu menu = this; menu != null; menu = menu.getParentMenu()) breadcrumb.add(menu);
