...
public abstract class IndexSettings {
  ...
  public static IndexSettings create(int newNumberOfShards, int newNumberOfReplicas) {
    return builder()
        .setNumberOfShards(newNumberOfShards)
        .setNumberOfReplicas(newNumberOfReplicas)
        .build();
  }

  public static Builder builder() {
    return new AutoValue_IndexSettings.Builder()
        .setNumberOfShards(DEFAULT_NUMBER_OF_SHARDS)
