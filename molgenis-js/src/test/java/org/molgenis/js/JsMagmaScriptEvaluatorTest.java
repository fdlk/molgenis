...
public class JsMagmaScriptEvaluatorTest {
  ...
  public void testUnitConversion() {
    ...
    Object weight =
        jsMagmaScriptEvaluator.eval("$('weight').unit('kg').toUnit('poundmass').value()", person);
  ...
  public void mapSimple() {
    ...
    Object result =
        jsMagmaScriptEvaluator.eval("$('gender').map({'20':'2','B':'B2'}).value()", person);
  ...
  public void mapDefault() {
    ...
    Object result =
        jsMagmaScriptEvaluator.eval("$('gender').map({'20':'2'}, 'B2').value()", person);
    assertEquals(result.toString(), "B2");
  }
  ...
  public void testGroup() {
    ...
    Object result2 =
        jsMagmaScriptEvaluator.eval("$('age').group([18, 35, 56], [888, 999]).value();", entity2);
  ...
  public void testGroupNull() {
    ...
    Object result6 =
        jsMagmaScriptEvaluator.eval(
            "$('age').group([56, 18, 35], null,'123456').value();", entity4);
  ...
  public void testPlusObject() {
    ...
    entity0.set("height", 180);
    Object result1 =
        jsMagmaScriptEvaluator.eval("$('height').plus(new newValue(100)).value()", entity0);
  ...
  public void testBmi() {
    ...
    Object bmi =
        jsMagmaScriptEvaluator.eval("$('weight').div($('height').div(100).pow(2)).value()", person);
