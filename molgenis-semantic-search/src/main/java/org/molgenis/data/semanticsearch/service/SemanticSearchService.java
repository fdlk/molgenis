...
public interface SemanticSearchService {
  /**
   * Find all relevant source attributes with an explanation based on ontology terms and search
   * terms
   *
   * @return Attribute of resembling attributes, sorted by relevance
   */
  Map<Attribute, ExplainedAttribute> findAttributes(
   ...
   *
   * <p>1. First find attributes based on searchTerms. 2. Second find attributes based on ontology
   * terms from tags 3. Third find attributes based on target attribute label.
   *
   * @return Attribute of resembling attributes, sorted by relevance
   */
