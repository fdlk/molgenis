...
public class PermissionSystemServiceImplTest extends AbstractMockitoTestNGSpringContextTests {
  @Captor private ArgumentCaptor<Stream<UserAuthority>> userAuthorityStreamCaptor;

  @Autowired private Config config;

  @Autowired private UserService userService;

  @Autowired private UserAuthorityFactory userAuthorityFactory;
  ...
  public void setUpBeforeMethod() {
    ...
    permissionSystemService =
        new PermissionSystemServiceImpl(
            userService, userAuthorityFactory, roleHierarchy, dataService);
  }
  ...
  public void giveUserEntityPermissions() {
    ...
    when(roleHierarchy.getReachableGrantedAuthorities(authorities))
        .thenAnswer(
            invocation ->
                asList(
                    new SimpleGrantedAuthority("newAuthority0"),
    ...
    Set<String> newAuthorities =
        SecurityContextHolder.getContext()
            ...
            .collect(toSet());
    assertEquals(
        newAuthorities, Sets.newHashSet("existingAuthority", "newAuthority0", "newAuthority1"));
  }
  ...
  public static class Config {
    ...
    @Mock private UserAuthorityFactory userAuthorityFactory;
