...
public class AnnotatorUtils {
  ...
  public static Map<String, Double> toAlleleMap(String alternatives, String annotations) {
    ...
    if (altArray.length == annotationsArray.length) {
      ...
      throw new MolgenisDataException(
          VcfAttributes.ALT + " differs in length from the provided annotations.");
    }
    return result;
  }
   ...
   */
  public static EntityType addAnnotatorMetaDataToRepositories(
      EntityType entityType, AttributeFactory attributeFactory, RepositoryAnnotator annotator) {
  ...
  private static void createCompoundForAnnotator(
