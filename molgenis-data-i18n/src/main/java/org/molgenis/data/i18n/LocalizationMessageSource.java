...
/**
 * A {@link org.springframework.context.MessageSource} that allows you to look up messages in the
 * LocalizationService.
 *
 * <p>Contains fallback logic that tries to fill in the best available value for a required Locale.
 * Marks missing values with # characters.
 *
 * <p>Caching is done by the {@link org.molgenis.data.DataService}.
 */
public class LocalizationMessageSource extends AbstractMessageSource {
  ...
  public LocalizationMessageSource(
      LocalizationService localizationService, String namespace, AppSettings appSettings) {
    super();
   ...
   *
   * <p>First tries the given locale, then the language specified in the {@link AppSettings} and
  ...
  protected String resolveCodeWithoutArguments(String code, Locale locale) {
    ...
    if (result == null) {
      result =
          localizationService.getMessage(namespace, code, LanguageService.DEFAULT_LANGUAGE_CODE);
    }
    return result;
  }
}
