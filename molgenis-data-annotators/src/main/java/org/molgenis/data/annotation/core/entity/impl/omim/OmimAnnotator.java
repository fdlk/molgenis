...
public class OmimAnnotator implements AnnotatorConfig {
  ...
  @Autowired private Entity omimAnnotatorSettings;
  ...
  public void init() {
    ...
    EntityAnnotator entityAnnotator =
        new AbstractAnnotator(
            ...
            new OmimResultFilter(entityTypeFactory, attributeFactory, this),
            dataService,
            resources,
            new SingleFileLocationCmdLineAnnotatorSettingsConfigurer(
                OMIM_LOCATION, omimAnnotatorSettings)) {
          @Override
  ...
  public Resource omimResource() {
    return new ResourceImpl(
        OMIM_RESOURCE, new SingleResourceConfig(OMIM_LOCATION, omimAnnotatorSettings)) {
      @Override
