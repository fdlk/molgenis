...
public class ClinvarAnnotatorTest extends AbstractMolgenisSpringTest {
  ...
  @Autowired private RepositoryAnnotator clinvarAnnotator;
  ...
  public void annotateIterable() {
    ...
    annotatedSourceMeta.addAttribute(
        attributeFactory.create().setName(ClinvarAnnotator.CLINVAR_CLNSIG));
    annotatedSourceMeta.addAttribute(
        attributeFactory.create().setName(ClinvarAnnotator.CLINVAR_CLNALLE));
