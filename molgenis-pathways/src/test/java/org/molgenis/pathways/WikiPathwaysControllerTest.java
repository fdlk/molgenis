...
public class WikiPathwaysControllerTest extends AbstractTestNGSpringContextTests {
  ...
  @Autowired private WikiPathwaysController controller;
  @Autowired private WikiPathwaysService serviceMock;
  ...
  public void testAnalyzeGPML() throws ParserConfigurationException, SAXException, IOException {
    ...
    assertEquals(
        controller.analyzeGPML(gpml), ImmutableMultimap.of("TUSC2", "cf7548", "IPO4", "d9af5"));
  }
  ...
  public void testGetAllPathways() throws ExecutionException {
    List<Pathway> allPathways =
        asList(Pathway.create("WP1234", "Pathway 1"), Pathway.create("WP12", "Pathway 2"));
  ...
  public void testGetColoredPathway()
    ...
    when(serviceMock.getColoredPathwayImage(
            "WP1234", ImmutableMap.of("cf7548", Impact.LOW, "d9af5", Impact.MODERATE)))
  ...
  public void testGetPathwaysByGenes() throws ExecutionException {
    ...
    assertEquals(
        ...
        asList(
            Pathway.create("WP1", "Pathway 1"),
            Pathway.create("WP2", "Pathway 2"),
            Pathway.create("WP3", "Pathway 3"),
            Pathway.create("WP4", "Pathway 4")));
  }
}
