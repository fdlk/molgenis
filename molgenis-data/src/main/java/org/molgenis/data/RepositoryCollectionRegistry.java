...
public class RepositoryCollectionRegistry {
  ...
  @Autowired
  public RepositoryCollectionRegistry(
      RepositoryCollectionDecoratorFactory repoCollectionDecoratorFactory) {
  ...
  public RepositoryCollection getRepositoryCollection(String name) {
    ...
    return repoCollection != null
        ? repoCollectionDecoratorFactory.createDecoratedRepositoryCollection(repoCollection)
        : null;
  }
  ...
  public RepositoryCollection getDefaultRepoCollection() {
    return repoCollectionDecoratorFactory.createDecoratedRepositoryCollection(
        defaultRepoCollection);
  }
