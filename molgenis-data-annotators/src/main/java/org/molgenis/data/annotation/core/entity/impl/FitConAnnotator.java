...
public class FitConAnnotator implements AnnotatorConfig {
  ...
  @Autowired private Entity fitConAnnotatorSettings;
  ...
  public void init() {
    ...
    EntityAnnotator entityAnnotator =
        new AbstractAnnotator(
            FITCON_TABIX_RESOURCE,
            fitconInfo,
            new LocusQueryCreator(vcfAttributes),
            new MultiAllelicResultFilter(attributes, vcfAttributes),
            dataService,
            resources,
            new SingleFileLocationCmdLineAnnotatorSettingsConfigurer(
                FITCON_LOCATION, fitConAnnotatorSettings)) {
          @Override
        ...
        new ResourceImpl(
          ...
          public RepositoryFactory getRepositoryFactory() {
            ...
            Attribute idAttribute =
                attributeFactory.create().setName("id").setVisible(false).setIdAttribute(true);
