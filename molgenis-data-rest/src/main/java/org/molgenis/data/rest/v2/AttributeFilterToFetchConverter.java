...
public class AttributeFilterToFetchConverter {
   ...
   * @return {@link Fetch}, or null for 'all attributes' {@link AttributeFilter} there are no
   *     refEntities
   * @throws UnknownAttributeException if the entity does not have one of the attributes mentioned
   *     in the filter
   */
  public static Fetch convert(
  ...
  private static void createFetchContentRec(
      AttributeFilter attrFilter, EntityType entityType, Fetch fetch, String languageCode) {
