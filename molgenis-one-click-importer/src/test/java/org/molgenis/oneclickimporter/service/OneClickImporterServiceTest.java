...
public class OneClickImporterServiceTest {
  ...
  public void testBuildDataCollectionWithSimpleValidExcelFile()
      throws IOException, InvalidFormatException, URISyntaxException, NoDataException,
          EmptySheetException {
  ...
  public void testBuildDataCollectionWithComplexValidCsvFile()
    ...
    when(csvService.splitLineOnSeparator("first name,last name,full name,UMCG employee,Age"))
        .thenReturn(header);
    ...
    when(csvService.splitLineOnSeparator("Dennis,Hendriksen,Dennis Hendriksen,TRUE,"))
        .thenReturn(line3);
    ...
    when(csvService.splitLineOnSeparator("Mariska,Slofstra,Mariska Slofstra,TRUE,22"))
        .thenReturn(line6);
    ...
    when(csvService.splitLineOnSeparator("Connor,Stroomberg,Connor Stroomberg,TRUE,"))
        .thenReturn(line8);
    ...
    Column c4 =
        Column.create(
            ...
            newArrayList(true, true, true, true, true, true, true, true, false, false));
    Column c5 =
        Column.create("Age", 4, newArrayList(26, null, null, null, null, 22, 27, null, 53, 32));
