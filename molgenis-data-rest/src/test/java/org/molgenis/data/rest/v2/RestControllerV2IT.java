...
import static org.molgenis.data.rest.convert.RestTestUtils.readJsonFile;
...
public class RestControllerV2IT {
  ...
  public void batchCreate() {
    ...
    given()
        ...
        .body(
            "location",
            equalTo("/api/v2/it_emx_datatypes_TypeTestRefv2?q=value=in=(\"ref55\",\"ref57\")"));
  }
  ...
  public void batchCreateTypeTest() {
    ...
    given()
        ...
        .body(
            "location",
            equalTo("/api/v2/it_emx_datatypes_TypeTestv2?q=id=in=(\"55\",\"57\")"),
            "resources[0].href",
            equalTo("/api/v2/it_emx_datatypes_TypeTestv2/55"),
            "resources[1].href",
