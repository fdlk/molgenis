...
public class UserManagerServiceImplTest extends AbstractTestNGSpringContextTests {
  ...
  @Autowired private GroupMemberFactory groupMemberFactory;
  ...
  public void getAllMolgenisUsersSu() {
    ...
    when(dataService.findAll(
            ...
            GroupMember.class))
        .thenReturn(Stream.of(groupMember0));
    when(dataService.findAll(
            GROUP_MEMBER,
    ...
    assertEquals(
        ...
        Arrays.asList(
            new UserViewData(user0, singletonList(group0)),
  ...
  public void getGroupsWhereUserIsMemberSu() {
    ...
    when(dataService.findAll(
            ...
            new QueryImpl<GroupMember>().eq(GroupMemberMetaData.USER, user1),
            GroupMember.class))
        .thenReturn(Stream.of(groupMemberOne, groupMemberTwo));
  ...
  public void getUsersMemberInGroup() {
    ...
    when(dataService.findAll(
            ...
            new QueryImpl<GroupMember>().eq(GroupMemberMetaData.USER, user1),
            GroupMember.class))
        .thenAnswer(invocation -> Stream.of(groupMember));
  ...
  public void getGroupsWhereUserIsNotMemberSu() {
    ...
    when(dataService.findAll(
            ...
            new QueryImpl<GroupMember>().eq(GroupMemberMetaData.USER, user1),
            GroupMember.class))
        .thenReturn(groupMemberships.stream());
  ...
  public void removeUserFromGroupSu() throws NumberFormatException {
    ...
    Query<GroupMember> q =
        new QueryImpl<GroupMember>()
            .eq(GroupMemberMetaData.USER, user1)
            .and()
  ...
  private void setSecurityContextSuperUser() {
    Collection<? extends GrantedAuthority> authorities =
        Arrays.asList(new SimpleGrantedAuthority(SecurityUtils.AUTHORITY_SU));
    ...
    Collection<? extends GrantedAuthority> authorities =
        Arrays.asList(
            ...
            new SimpleGrantedAuthority(
                SecurityUtils.AUTHORITY_PLUGIN_WRITE_PREFIX + "USERMANAGER"));
    SecurityContextHolder.getContext()
        .setAuthentication(new UsernamePasswordAuthenticationToken(null, null, authorities));
  }
}
