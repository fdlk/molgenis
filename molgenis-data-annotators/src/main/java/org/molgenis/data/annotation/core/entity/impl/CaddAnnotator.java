...
public class CaddAnnotator implements AnnotatorConfig {
  ...
  @Autowired private Entity caddAnnotatorSettings;
  ...
  public void init() {
    ...
    EntityAnnotator entityAnnotator =
        new AbstractAnnotator(
            CADD_TABIX_RESOURCE,
            caddInfo,
            new LocusQueryCreator(vcfAttributes),
            new MultiAllelicResultFilter(attributes, true, vcfAttributes),
            dataService,
            resources,
            new SingleFileLocationCmdLineAnnotatorSettingsConfigurer(
                CaddAnnotatorSettings.Meta.CADD_LOCATION, caddAnnotatorSettings)) {
          @Override
    ...
    return new ResourceImpl(
      ...
      public RepositoryFactory getRepositoryFactory() {
        ...
        repoMetaData.addAttribute(
            attributeFactory.create().setName(CADD_SCALED).setDataType(STRING));
        Attribute idAttribute =
            attributeFactory.create().setName(idAttrName).setVisible(false).setIdAttribute(true);
