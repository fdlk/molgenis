...
public class LongAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  public Object[][] validConversionData() {
    return new Object[][] {
      ...
      {1L, ENUM, "1"},
      {1L, XREF, "label1"},
      {1L, CATEGORICAL, "label1"}
    };
  }

  /**
   * Valid conversion cases for LONG to: STRING, TEXT, INT, DECIMAL, ENUM, XREF, CATEGORICAL
   *
  ...
  public void testValidConversion(
      long valueToConvert, AttributeType typeToConvertTo, Object convertedValue) {
  ...
  /**
   * Invalid conversions cases for LONG to: XREF, CATEGORICAL, ENUM, DATE, DATE_TIME, MREF,
   * CATEGORICAL_MREF, EMAIL, HTML, HYPERLINK, COMPOUND, FILE, BOOL, SCRIPT, ONE_TO_MANY
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
