...
public class SecurityDecoratorUtilsTest extends AbstractTestNGSpringContextTests {
  ...
  @WithMockUser(
    username = "USER",
    authorities = {"ROLE_ENTITY_READ_entityTypeId"}
  )
  @Test
  ...
  @WithMockUser(
    username = "USER",
    authorities = {"ROLE_ENTITY_COUNT_entityTypeId"}
  )
  @Test(
    expectedExceptions = MolgenisDataAccessException.class,
    expectedExceptionsMessageRegExp =
        "No \\[READ\\] permission on entity type \\[entityTypeLabel\\] with id \\[entityTypeId\\]"
  )
  ...
  @WithMockUser(
    username = "USER",
    authorities = {"ROLE_ENTITY_COUNT_otherEntityTypeId"}
  )
  @Test(
    expectedExceptions = MolgenisDataAccessException.class,
    expectedExceptionsMessageRegExp =
        "No \\[COUNT\\] permission on entity type \\[entityTypeLabel\\] with id \\[entityTypeId\\]"
  )
