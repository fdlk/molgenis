...
public class PostgreSqlNameGenerator {
   ...
   *
   * <p>https://www.postgresql.org/docs/current/static/sql-syntax-lexical.html#SQL-SYNTAX-IDENTIFIERS
   */
  ...
  private static String getTableName(
      EntityType entityType, boolean quotedIdentifier, int maxLength) {
   ...
   */
  public static String getJunctionTableName(
    ...
    return quotedIdentifier
        ? getQuotedIdentifier(entityPart + '_' + attrPart)
        : entityPart + '_' + attrPart;
  }
   ...
   */
  static String getJunctionTableIndexName(
  ...
  private static String getConstraintName(
      EntityType entityType, Attribute attr, String constraintPostfix) {
