...
public class PostgreSqlRepositoryTest {
  ...
  public void findAllQueryOneToManyEquals() throws Exception {
    ...
    String sql =
        "SELECT DISTINCT this.\"entityId\", (SELECT array_agg(\"refEntityId\" ORDER BY \"refEntityId\" ASC) FROM \"refEntityId#07f902bf\" WHERE this.\"entityId\" = \"refEntityId#07f902bf\".\"xrefAttr\") AS \"oneToManyAttr\" FROM \"entityId#fc2928f6\" AS this LEFT JOIN \"refEntityId#07f902bf\" AS \"oneToManyAttr_filter1\" ON (this.\"entityId\" = \"oneToManyAttr_filter1\".\"xrefAttr\") WHERE \"oneToManyAttr_filter1\".\"refEntityId\" = ?  LIMIT 1000";
    @SuppressWarnings("unchecked")
  ...
  public void testUpdateEntityDoesNotExist() {
    ...
    when(jdbcTemplate.query(any(String.class), any(Object[].class), isNull(RowMapper.class)))
        .thenReturn(singletonList(entity0));
    when(jdbcTemplate.batchUpdate(any(String.class), any(BatchPreparedStatementSetter.class)))
