...
/**
 * Base class for any {@link EntityAnnotator} that uses a {@link QueryCreator} to query the {@link
 * DataService} or {@link Resources}. It leaves it up to concrete implementations how they wish to
 * process the results by implementing {@link #processQueryResults(Entity, Iterable, boolean)}.
 *
 * <p>See {@link AbstractAnnotator} for the most standard implementation of {@link
...
public abstract class QueryAnnotatorImpl implements EntityAnnotator {
  ...
  public boolean sourceExists() {
    return resources.hasRepository(sourceRepositoryName)
   ...
   */
  protected abstract void processQueryResults(
      Entity inputEntity, Iterable<Entity> annotationSourceEntities, boolean updateMode);
}
