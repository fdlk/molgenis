 ...
 *
 * <p>TransactionListeners can be registered and will be notified on transaction begin, commit and
 * rollback of transactions that are not readonly.
 *
...
public class PostgreSqlTransactionManager extends DataSourceTransactionManager
  ...
  protected boolean isExistingTransaction(Object transaction) {
    return super.isExistingTransaction(
        ((MolgenisTransaction) transaction).getDataSourceTransaction());
  }
