...
public class JobsControllerTest {
  ...
  public void beforeClass() {
    ...
    jobsController =
        new JobsController(
            userAccountService, dataService, jobMetaDataMetaData, jobScheduler, menuReaderService);
  }
