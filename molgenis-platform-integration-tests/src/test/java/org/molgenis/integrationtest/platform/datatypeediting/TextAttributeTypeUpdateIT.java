...
public class TextAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  /**
   * Valid conversion cases for TEXT to: INT, STRING, BOOL, DECIMAL, LONG, XREF, CATEGORICAL,
  ...
  /**
   * Invalid conversion cases for TEXT to: STRING, BOOL, INT, LONG, DECIMAL, XREF, CATEGORICAL,
   * EMAIL, HYPERLINK, ENUM, DATE, DATE_TIME, MREF, CATEGORICAL_MREF, FILE
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
