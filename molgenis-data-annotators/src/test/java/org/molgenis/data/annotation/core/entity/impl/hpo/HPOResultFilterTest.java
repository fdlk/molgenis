...
@ContextConfiguration(
  classes = {HPOAnnotator.class, HPOResultFilterTest.Config.class, GeneNameQueryCreator.class}
)
public class HPOResultFilterTest extends AbstractMolgenisSpringTest {
  ...
  @Autowired HPOAnnotator hpoAnnotator;
  ...
  public void filterResults() {
    ...
    Optional<Entity> result =
        filter.filterResults(Arrays.asList(e1, e2), new DynamicEntity(resultEntityType), false);
