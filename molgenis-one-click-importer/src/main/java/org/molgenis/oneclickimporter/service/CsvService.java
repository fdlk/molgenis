...
public interface CsvService {
  ...
  /**
   * Creates a List containing the lines of a CSV file Including the header
   *
   * @param file
   */
  ...
  /**
   * Splits a line from a file based on a separator. Takes into account values between '""'
   *
   * <p>e.g. "hello,world","21",43,"21,5" is split into ["hello,world", "21", "43", "21,5"]
   *
   * @param line
   * @param separator
