...
public class PostgreSqlQueryGeneratorTest {
  ...
  public void getSqlCreateForeignKey() {
    ...
    String expectedSql =
        "ALTER TABLE \"entityTypeId#c34894ba\" ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityId#07f902bf\"(\"refIdAttr\")";
  ...
  public void getSqlCreateJunctionTable() {
    ...
    String expectedSql =
        "CREATE TABLE \"entityTypeId#c34894ba_attr\" (\"order\" INT,\"idAttr\" character varying(255) NOT NULL, \"attr\" character varying(255) NOT NULL, FOREIGN KEY (\"idAttr\") REFERENCES \"entityTypeId#c34894ba\"(\"idAttr\") ON DELETE CASCADE, FOREIGN KEY (\"attr\") REFERENCES \"refEntityId#07f902bf\"(\"refIdAttr\"), UNIQUE (\"idAttr\",\"attr\"), UNIQUE (\"order\",\"idAttr\"))";
  ...
  public Iterator<Object[]> getSqlSelectOneToManyMappedByProvider() {
    ...
    dataList.add(
        new Object[] {
          new QueryImpl<>().in("attr", asList("ref0", "ref1")),
  ...
  public void getSqlSelectOneToManyMappedBy(
      Query<Entity> query, String expectedSql, List<Object> expectedParameters) {
    Attribute refIdAttr = when(mock(Attribute.class).getName()).thenReturn("refIdAttr").getMock();
    when(refIdAttr.getIdentifier()).thenReturn("refIdAttrId");
    when(refIdAttr.getDataType()).thenReturn(STRING);
    EntityType refEntityType =
  ...
  public void getSqlSelectMref() {
    ...
    EntityType entityType =
        when(mock(EntityType.class).getId()).thenReturn("org_molgenis_MasterEntity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
  ...
  public static Iterator<Object[]> getSqlAddColumnProvider() {
    ...
    return Arrays.asList(
            new Object[] {
              BOOL, true, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" boolean"
            },
            new Object[] {
              CATEGORICAL,
              true,
            ...
            new Object[] {
              DATE, true, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" date"
            },
            new Object[] {
              DATE_TIME,
              true,
            ...
            new Object[] {
              HTML, true, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" text"
            },
            new Object[] {
              HYPERLINK,
              true,
            ...
            new Object[] {
              INT, true, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" integer"
            },
            new Object[] {
              LONG, true, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" bigint"
            },
            new Object[] {
              SCRIPT, true, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" text"
            },
            new Object[] {
              STRING,
              true,
            ...
            new Object[] {
              TEXT, true, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" text"
            },
            new Object[] {
              XREF,
              true,
            ...
            new Object[] {
              DATE, false, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" date NOT NULL"
            },
            new Object[] {
              DATE_TIME,
              false,
            ...
            new Object[] {
              HTML, false, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" text NOT NULL"
            },
            new Object[] {
              HYPERLINK,
              false,
            ...
            new Object[] {
              TEXT, false, null, "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" text NOT NULL"
            },
            new Object[] {
              XREF,
              false,
  ...
  public void getSqlAddColumn(
      AttributeType attrType, boolean nillable, EntityType refEntityType, String sql) {
  ...
  public static Iterator<Object[]> getSqlAddColumnInvalidTypeProvider() {
    return Arrays.asList(
            new Object[] {COMPOUND}, new Object[] {CATEGORICAL_MREF}, new Object[] {MREF})
        .iterator();
  }
  ...
  public void getSqlFrom() {
    ...
    EntityType collectionsEntity =
        createMockEntityWithIdAttribute(
            "eu_bbmri_eric_collections", collectionsIdAttribute, "collectionsId");
    Attribute typeIdAttribute = createIdAttribute("typeId");
    EntityType typeEntity =
        createMockEntityWithIdAttribute("eu_bbmri_eric_type", typeIdAttribute, "typeId");
    Attribute categoryIdAttribute = createIdAttribute("categoryId");
    EntityType categoryEntity =
        createMockEntityWithIdAttribute(
            "eu_bbmri_eric_category", categoryIdAttribute, "categoryId");
  ...
  public void getSqlWhere() {
    ...
    QueryRule typeRule =
        new QueryRule(
            NESTED,
            newArrayList(
                new QueryRule("type", EQUALS, "POPULATION_BASED"),
                new QueryRule(OR),
                new QueryRule("type", EQUALS, "QUALITY_CONTROL")));
    QueryRule categoryRule =
        new QueryRule(
            NESTED,
            newArrayList(
                new QueryRule("data_categories", EQUALS, "MEDICAL_RECORDS"),
                new QueryRule(OR),
    ...
    QueryImpl<Entity> q =
        new QueryImpl<>(
            new QueryRule(
                NESTED, newArrayList(newArrayList(typeRule, new QueryRule(AND), categoryRule))));
  ...
  private EntityType createMockEntityWithIdAttribute(
      String entityTypeId, Attribute idAttribute, String idAttributeName) {
