...
public class OntologyTagServiceTest extends AbstractMolgenisSpringTest {
  ...
  private static final OntologyTerm CHROMOSOME_NAME_ONTOLOGY_TERM =
      OntologyTerm.create(
          "http://edamontology.org/data_0987", "Chromosome name", "Name of a chromosome.");

  private static final OntologyTerm GENE_ANNOTATION_ONTOLOGY_TERM =
      OntologyTerm.create(
  ...
  public void testAddAttributeTag() {
    ...
    SemanticTag<Attribute, OntologyTerm, Ontology> chromosomeTag =
        new SemanticTag<>(
            "1233", attribute, instanceOf, CHROMOSOME_NAME_ONTOLOGY_TERM, EDAM_ONTOLOGY);
    ...
    when(tagRepository.getTagEntity(
            ...
            instanceOf,
            "http://edamontology.org"))
        .thenReturn(chromosomeNameTagEntity);
  ...
  public void testRemoveAttributeTag() {
    ...
    SemanticTag<Attribute, OntologyTerm, Ontology> geneAnnotationTag =
        new SemanticTag<>(
            "4321", attribute, instanceOf, GENE_ANNOTATION_ONTOLOGY_TERM, EDAM_ONTOLOGY);
  ...
  public void testRemoveAllTagsFromEntity() {
    ...
    when(dataService.findOneById(ENTITY_TYPE_META_DATA, "test", EntityType.class))
        .thenReturn(entityTypeEntity);
