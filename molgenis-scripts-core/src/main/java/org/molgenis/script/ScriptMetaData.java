...
public class ScriptMetaData extends SystemEntityType {
  ...
  public static final String GENERATE_TOKEN =
      "generateToken"; // If true a security token is generated for the script
  // (available as ${molgenisToken})
  public static final String RESULT_FILE_EXTENSION =
      "resultFileExtension"; // If the script generates an outputfile,
  // this is it's file extension
  // (outputfile available as
  // ${outputFile})
  public static final String PARAMETERS =
      "parameters"; // The names of the parameters required by this script
  ...
  public void init() {
    ...
    addAttribute(GENERATE_TOKEN)
        .setDataType(BOOL)
        .setLabel("Generate security token")
