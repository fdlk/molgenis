...
public class AutoValuePopulatorTest
{
	...
	public void populateAutoValues()
	{
		...
		assertNull(entity.getUtilDate(ATTR_DATETIME_AUTO_DEFAULT));
		assertNull(entity.getUtilDate(ATTR_DATETIME_AUTO_FALSE));
		assertNotNull(entity.getUtilDate(ATTR_DATETIME_AUTO_TRUE));
	}
}