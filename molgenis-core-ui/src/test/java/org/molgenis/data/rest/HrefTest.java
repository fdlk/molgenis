...
public class HrefTest {
  ...
  public static void testEntityType() {
    Assert.assertEquals(
        Href.concatMetaEntityHref("http://molgenis.org/api/v1", "org_test_TypeTest"),
  ...
  public static void testEntityTypeV2() {
    Assert.assertEquals(
        Href.concatMetaEntityHrefV2("http://molgenis.org/api/v2", "org_test_TypeTest"),
  ...
  public static void testEntity() {
    Assert.assertEquals(
        Href.concatEntityHref("http://molgenis.org/api/v1", "org_test_TypeTest", "1"),
  ...
  public static void testEntityUrlEncodeIdWithSpace() {
    Assert.assertEquals(
        Href.concatEntityHref("http://molgenis.org/api/v1", "org_test_TypeTest", "weird id"),
  ...
  public static void testAttribute() {
    Assert.assertEquals(
        Href.concatMetaAttributeHref("http://molgenis.org/api/v1", "org_test_TypeTest", "xint"),
  ...
  public static void testAttributeEntity() {
    Assert.assertEquals(
        Href.concatAttributeHref("http://molgenis.org/api/v1", "org_test_TypeTest", "1", "xint"),
  ...
  public static void testAttributeUrlEncodeIdWithSpace() {
    Assert.assertEquals(
        Href.concatAttributeHref(
            "http://molgenis.org/api/v1", "org_test_TypeTest", "weird id", "xint"),
  ...
  public static void testConcatEntityCollectionHref() {
    Assert.assertEquals(
        Href.concatEntityCollectionHref(
            "http://molgenis.org/api/v2", "entity", "id", Arrays.asList("p1", "p2")),
        "http://molgenis.org/api/v2/entity?q=id=in=(\"p1\",\"p2\")");
  }
}
