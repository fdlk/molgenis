...
public class DirectorySettings extends DefaultSettingsEntity {
  ...
  private static final String NEGOTIATOR_URL_DEFAULT =
      "https://bbmri-dev.mitro.dkfz.de/api/directory/create_query";
  ...
  public static class Meta extends DefaultSettingsEntityType {
    ...
    public void init() {
      ...
      addAttribute(NEGOTIATOR_URL)
          .setLabel("Negotiator endpoint url")
      ...
      addAttribute(COLLECTION_ENTITY)
          .setLabel("Collection entity")
