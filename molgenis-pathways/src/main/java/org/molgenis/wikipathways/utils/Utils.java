...
public class Utils {
  ...
  public static String update(String url, HttpClient client, Map<String, String> attributes)
      throws Exception {
  ...
  public static WSPathway parsePathway(Element pathway) throws UnsupportedEncodingException {
    String gpml =
        new String(Base64.decodeBase64(pathway.getChildText("gpml", WSNamespaces.NS2)), "UTF-8");
