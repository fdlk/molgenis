...
public class MultiFileResourceTest extends AbstractMockitoTest {
  ...
  @Mock private MultiResourceConfig config;
  @Mock private RepositoryFactory factory;
  private Map<String, ResourceConfig> configs;
  @Mock private ResourceConfig chrom3Config;
  @Mock private ResourceConfig chrom4Config;
  @Mock private Repository<Entity> chrom3Repository;
  @Mock private Repository<Entity> chrom4Repository;
  ...
  public void beforeMethod() {
    ...
    multiFileResource =
        new MultiFileResource("name", config) {
          @Override
