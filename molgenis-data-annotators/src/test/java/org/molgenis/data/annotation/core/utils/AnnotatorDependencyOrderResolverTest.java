...
public class AnnotatorDependencyOrderResolverTest extends AbstractMolgenisSpringTest {
  ...
  @Mock RepositoryAnnotator annotator1, annotator2, annotator3, annotator4, annotator5;
  @Mock
  ...
  public void testSucces() {
    ...
    Queue<RepositoryAnnotator> result =
        resolver.getAnnotatorSelectionDependencyList(available, requested, repo, entityTypeFactory);
