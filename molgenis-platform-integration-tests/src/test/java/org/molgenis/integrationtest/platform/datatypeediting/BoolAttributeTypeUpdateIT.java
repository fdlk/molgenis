...
public class BoolAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  /**
   * Valid conversion cases for BOOLEAN to: STRING, TEXT, INT
   *
  ...
  public void testValidConversion(
      boolean valueToConvert, AttributeType typeToConvertTo, Object convertedValue) {
  ...
  /**
   * Invalid conversion cases for BOOL to: DECIMAL, LONG, MREF, XREF, CATEGORICAL, CATEGORICAL_MREF,
   * FILE, COMPOUND, EMAIL, HTML, HYPERLINK, DATE, DATE_TIME, ENUM, ONE_TO_MANY, SCRIPT
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
