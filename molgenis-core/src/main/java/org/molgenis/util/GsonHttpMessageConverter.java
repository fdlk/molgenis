...
/**
 * Converts objects to json string and vica versa If logging is set to debug it will print the
 * incoming and outgoing json strings
 *
 * @author Roy Clarkson
 * @since 1.0
 */
public class GsonHttpMessageConverter extends BaseHttpMessageConverter<Object> {
  ...
  /**
   * Indicates whether the JSON output by this view should be prefixed with "{} &&". Default is
   * false.
   *
