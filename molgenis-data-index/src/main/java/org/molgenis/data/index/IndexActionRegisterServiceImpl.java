...
/**
 * Registers changes made to an indexed repository that need to be fixed by indexing the relevant
 * data.
 */
@Component
public class IndexActionRegisterServiceImpl
  ...
  private final SetMultimap<String, Impact> changesPerTransaction =
