...
public class VcfToEntityTest extends AbstractMolgenisSpringTest {
  ...
  public void beforeTest() throws IOException {
    ...
    vcfToEntitySmall =
        new VcfToEntity(
            "EntityNameSmall", vcfMetaSmall, vcfAttrs, entityTypeFactory, attrMetaFactory);
  }
  ...
  public void testGetEntityType() {
    ...
    Attribute internalIdMeta =
        attrMetaFactory.create().setName(INTERNAL_ID).setDataType(STRING).setVisible(false);
  ...
  public void testToEntityAlternativeAlleles() throws IOException {
    VcfRecord record =
        new VcfRecord(
            vcfMetaSmall,
            new String[] {
              "10", "12345", "id3", "A", "A,C,G,T,N,*", "7.9123", "pass", "DF;DF2;CHAR=-"
            });
    Entity entity = vcfToEntitySmall.toEntity(record);
    Entity expected = new DynamicEntity(vcfToEntitySmall.getEntityType());
    expected.set("#CHROM", "10");
  ...
  public void testToEntityMissingValues() throws IOException {
    ...
    VcfToEntity vcfToEntity =
        new VcfToEntity("entityTypeName", vcfMeta, vcfAttrs, entityTypeFactory, attrMetaFactory);
    VcfRecord record =
        new VcfRecord(
