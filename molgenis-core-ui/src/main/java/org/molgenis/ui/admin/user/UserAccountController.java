...
public class UserAccountController extends PluginController {
  ...
  public void updateAccount(@Valid @NotNull AccountUpdateRequest updateRequest) {
    ...
    if (StringUtils.isNotEmpty(updateRequest.getAddress()))
      user.setAddress(updateRequest.getAddress());
    if (StringUtils.isNotEmpty(updateRequest.getTitle())) user.setTitle(updateRequest.getTitle());
    if (StringUtils.isNotEmpty(updateRequest.getFirstname()))
      user.setFirstName(updateRequest.getFirstname());
    if (StringUtils.isNotEmpty(updateRequest.getMiddleNames()))
      user.setMiddleNames(updateRequest.getMiddleNames());
    if (StringUtils.isNotEmpty(updateRequest.getLastname()))
      user.setLastName(updateRequest.getLastname());
    if (StringUtils.isNotEmpty(updateRequest.getInstitute()))
      user.setAffiliation(updateRequest.getInstitute());
    if (StringUtils.isNotEmpty(updateRequest.getDepartment()))
      user.setDepartment(updateRequest.getDepartment());
    if (StringUtils.isNotEmpty(updateRequest.getPosition()))
  ...
  /**
   * Set AuthenticationToken back to {@link UsernamePasswordAuthenticationToken} generated with
