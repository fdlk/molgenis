...
public class DirectoryController extends PluginController {
  ...
  public DirectoryController(
      DirectorySettings settings, RestTemplate restTemplate, PermissionService permissions) {
    super(URI);
  ...
  public String exportToNegotiator(@RequestBody NegotiatorQuery query) throws Exception {
    ...
    try {
      ...
      String redirectURL =
          restTemplate.postForLocation(settings.getNegotiatorURL(), entity).toASCIIString();
