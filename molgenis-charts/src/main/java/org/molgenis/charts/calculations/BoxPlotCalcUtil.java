...
public class BoxPlotCalcUtil {
   ...
   *
   * <p>Double[0] = minimum; Double[1] = firstQuantile; Double[2] = median; Double[3] =
   * thirdQuantile; Double[4] = maximum;
   *
   * @return Double[]
   */
   ...
   *
   * <p>Inspired on: http://msenux.redwoods.edu/math/R/boxplot.php
   *
   * @param sortedDataAscendingOrder sorted data in ascending order (NOT NULL)
   * @param p percentage
   * @return Double interpolated linearly quantile
   */
  private static Double interpolateLinearlyQuantile(
      List<Double> sortedDataAscendingOrder, Double p) {
