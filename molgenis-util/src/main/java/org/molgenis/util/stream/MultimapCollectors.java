 ...
 *
 * <p>see {@link Collectors#toMap(Function, Function)}, the equivalent of which is not (yet?)
 * present in guava for the {@link Multimap}.
 */
public class MultimapCollectors {
  public static <K, V, E>
      Collector<E, ArrayListMultimap<K, V>, ArrayListMultimap<K, V>> toArrayListMultimap(
  ...
  public static <K, V, A extends Multimap<K, V>, E> Collector<E, A, A> toMultimap(
      Supplier<A> supplier, Function<E, K> keyGenerator, Function<E, V> valueGenerator) {
    return Collector.of(
        supplier,
  ...
  public static <K, V, A extends Multimap<K, V>> Collector<Entry<K, V>, A, A> toMultimap(
      Supplier<A> supplier) {
    return toMultimap(supplier, Entry::getKey, Entry::getValue);
  }

  public static <K, V>
      Collector<Entry<K, V>, LinkedHashMultimap<K, V>, LinkedHashMultimap<K, V>>
