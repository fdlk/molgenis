    ...
    <#if biobankSampleCollections?has_content>
        <div class="btn-group" role="group">
            <button type="button" id="add-mapping-project-btn" class="btn btn-primary" data-toggle="modal"
                    data-target="#create-new-biobank-universe-modal"><span class="glyphicon glyphicon-plus"></span>&nbsp;Add
                Biobank universe
            </button>
        </div>
    </#if>
        ...
        <table class="table table-bordered" id="biobank-universes-tbl">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a id="add-new-member-btn" href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                           data-target="#model-${universe.identifier}"><span
                                class="glyphicon glyphicon-plus"></span></a>
                        <!-- add new member dialog -->
                        <div class="modal" id="model-${universe.identifier}" tabindex="-1" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="create-new-members-form" method="post"
                                          action="${context_url}/addUniverseMembers">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title" id="create-new-source-column-modal-label">Add new
                                                members</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Add new members to the universe: ${universe.name?html}</label>
                                                <select name="biobankSampleCollectionNames" class="form-control"
                                                        multiple="multiple">
                                                    <#assign existingMembers = [] />
                                                    <#list universe.members as member>
                                                        <#assign existingMembers = existingMembers + [member.name] /><#if member_has_next>
                                                        , </#if>
                                                    </#list>
                                            ...
                                            <input type="hidden" name="biobankUniverseId"
                                                   value="${universe.identifier}">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" id="submit-new-member-column-btn"
                                                    class="btn btn-primary">Add members
                                            </button>
                    ...
                    <td>
                        <a id="add-new-key-concepts-btn" href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                           data-target="#model-key-concepts-${universe.identifier}"><span
                                class="glyphicon glyphicon-plus"></span></a>
                        <!-- add new member dialog -->
                        <div class="modal" id="model-key-concepts-${universe.identifier}" tabindex="-1" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="create-new-key-concepts-form" method="post"
                                          action="${context_url}/addKeyConcepts">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title" id="create-new-source-column-modal-label">Add new
                                                key concepts</h4>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Add new key concepts to the
                                                    universe: ${universe.name?html}</label>
                                                <select name="semanticTypes" class="form-control" multiple="multiple">
                                                    ...
                                                    <#list universe.keyConcepts as keyConcept>
                                                        <#assign existingKeyConceptGroups = existingKeyConceptGroups + [keyConcept.name] /><#if keyConcept_has_next>
                                                        , </#if>
                                                    </#list>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" id="submit-new-member-column-btn"
                                                    class="btn btn-primary">Add key concepts
                                            </button>
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel
                                            </button>
                                        </div>
                    ...
                    <td>
                        <div id="progress-bar-${universe.identifier}" name="progress-bar"
                             biobank-universe="${universe.identifier}"></div>
                    </td>
                </tr>
                </#list>
            </tbody>
...
<div class="modal fade" id="create-new-biobank-universe-modal" tabindex="-1" role="dialog"
     aria-labelledby="create-new-biobank-universe-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="${context_url}/addUniverse">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input name="universeName" type="text" class="form-control" placeholder="Universe name"
                               required="required">
                    </div>
                    <hr></hr>
                    <div class="form-group">
