...
public class LanguageService {
  ...
  public LanguageService(
      DataService dataService, AppSettings appSettings, LocalizationService localizationService) {
   ...
   *
   * <p>See {@link LocalizationMessageSource} documentation for lookup implementation details.
   *
   * <p>The ResourceBundle is a Spring {@link MessageSourceResourceBundle} which means that you
   * cannot query its keys. Ask the {@link LocalizationService} instead.
   */
  ...
  public MessageSourceResourceBundle getBundle(String languageCode) {
    return new MessageSourceResourceBundle(
        getMessageSource(NAMESPACE_ALL), new Locale(languageCode));
  }
          ...
          if (currentUserName != null) {
            ...
            if (user != null) {
              ...
              if ((languageCode != null)
                  && (dataService.findOneById(LANGUAGE, languageCode) == null)) {
                languageCode = null;
              }
            }
          }
