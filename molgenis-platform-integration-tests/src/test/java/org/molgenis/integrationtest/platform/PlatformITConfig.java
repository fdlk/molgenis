...
@ComponentScan({
  ...
  "org.molgenis.data.importer.config",
  "org.molgenis.data.excel",
  "org.molgenis.util",
  "org.molgenis.settings",
  "org.molgenis.data.settings"
})
@Import({
  ...
  org.molgenis.data.FileRepositoryCollectionFactory.class,
...
public class PlatformITConfig implements ApplicationListener<ContextRefreshedEvent> {
  ...
  @Autowired private RepositoryCollectionBootstrapper repoCollectionBootstrapper;
  @Autowired private SystemEntityTypeRegistrar systemEntityTypeRegistrar;
  ...
  @Autowired private JobFactoryRegistrar jobFactoryRegistrar;
