...
public class SecurityUtils {
  ...
  public static boolean currentUserIsAuthenticated() {
    ...
    return authentication != null
        ...
        && !currentUserHasRole(AUTHORITY_ANONYMOUS);
  }
  ...
  public static List<String> getEntityAuthorities(String entityTypeId) {
    ...
    for (Permission permission : Permission.values()) {
      String authority =
          String.format("%s%s_%s", AUTHORITY_ENTITY_PREFIX, permission.name(), entityTypeId);
