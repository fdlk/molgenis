...
public class DecimalAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  /**
   * Valid conversion cases for DECIMAL to: STRING, TEXT, INT, LONG, ENUM
   *
  ...
  public void testValidConversion(
      double valueToConvert, AttributeType typeToConvertTo, Object convertedValue) {
  ...
  /**
   * Invalid conversions cases for DECIMAL to: XREF, CATEGORICAL, ENUM, DATE, DATE_TIME, MREF,
