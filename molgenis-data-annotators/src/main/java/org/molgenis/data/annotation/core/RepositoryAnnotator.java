...
/**
 * interface for annotators. annotators take an iterator and return an iterator with some
 * information added or updated
 */
public interface RepositoryAnnotator {
  ...
  /**
   * Checks if folder and files that were set with a runtime property actually exist, or if a
   * webservice can be reached
   *
   * @return boolean
   */
