...
public final class IntermediateParseResults {
  ...
  public IntermediateParseResults(
      EntityTypeFactory entityTypeFactory, DefaultPackage defaultPackage) {
  ...
  public EntityType addEntityType(String fullyQualifiedName) {
    ...
    if (pack == null) {
      ...
      entityTypeId =
          DefaultPackage.PACKAGE_DEFAULT + Package.PACKAGE_SEPARATOR + fullyQualifiedName;
    } else {
      entityTypeId = fullyQualifiedName;
    }

    EntityType emd =
        entityTypeFactory.create(entityTypeId).setLabel(entityTypeLabel).setPackage(pack);
