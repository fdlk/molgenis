...
public class GenomeBrowserTrackTest {
  ...
  public void testToTrack() throws Exception {
    ...
    GenomeBrowserAttributes genomeBrowserAttributes =
        GenomeBrowserServiceTest.getGenomeBrowserAttributes("postion", "chrom", "normal", "mutant");
    ...
    String expected =
        "{\"genome_attrs\":{\"ref\":\"normal\",\"pos\":\"postion\",\"alt\":\"mutant\",\"chr\":\"chrom\"},\"name\":\"label\",\"label_attr\":\"entityLabel\",\"tier_type\":\"molgenis\",\"actions\":\"alert(\\\"test\\\")\",\"track_type\":\"VARIANT\",\"attrs\":[\"attr 1:attr1\",\"reference attribute:REF\",\"position on genome:POS\"]}";
