...
public class SecurityUtilsTest {
  ...
  public void currentUserIsAuthenticated_falseAnonymous() {
    ...
    GrantedAuthority authoritySu =
        when(mock(GrantedAuthority.class).getAuthority()).thenReturn(AUTHORITY_ANONYMOUS).getMock();
    when((Collection<GrantedAuthority>) authentication.getAuthorities())
  ...
  public void defaultPluginAuthorities() {
    ...
    assertEquals(
        defaultPluginAuthorities,
        new String[] {
          AUTHORITY_SU,
          AUTHORITY_PLUGIN_READ_PREFIX + pluginId,
  ...
  public void getEntityAuthorities() {
    ...
    List<String> expected =
        Arrays.asList(
            "ROLE_ENTITY_READ_test",
            "ROLE_ENTITY_WRITE_test",
            "ROLE_ENTITY_COUNT_test",
            "ROLE_ENTITY_NONE_test",
            "ROLE_ENTITY_WRITEMETA_test");
