...
import static org.molgenis.data.annotation.core.entity.impl.gavin.Category.C1;
import static org.molgenis.data.annotation.core.entity.impl.gavin.Category.C3;
...
public class GavinAlgorithmTest {
  ...
  public void testClassifyVariant(
      Impact impact,
      Double caddScaled,
      Double exacMAF,
      String gene,
  ...
  public void testGenomeWideClassifyVariant(
      Impact impact,
      Double caddScaled,
      Double exacMAF,
      String gene,
  ...
  public void testHighCaddPathogenic() {
    assertEquals(
        gavinAlgorithm.classifyVariant(HIGH, 80.0, 1e-5, "TFR2", tfr2Thresholds),
        Judgment.create(
            Pathogenic,
            calibrated,
            "TFR2",
  ...
  public void testLowVariantCaddBenign() {
    assertEquals(
        gavinAlgorithm.classifyVariant(HIGH, 6.0, 1e-5, "TFR2", tfr2Thresholds),
        Judgment.create(
            Benign,
            calibrated,
            "TFR2",
  ...
  public void testNoCaddVOUS() {
    assertEquals(
        gavinAlgorithm.classifyVariant(HIGH, null, 1e-5, "TFR2", tfr2Thresholds),
        Judgment.create(
            VOUS,
            genomewide,
            "TFR2",
  ...
  public void testNullThresholdsZeroMAF() {
    ...
    assertEquals(
        gavinAlgorithm.classifyVariant(
            HIGH, 80.0, 1e-5, "ABCD1", GavinThresholds.create(0.0, null, null, null, null, I1)),
