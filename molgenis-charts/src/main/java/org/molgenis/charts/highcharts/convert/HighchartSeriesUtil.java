...
public class HighchartSeriesUtil {
  /**
   * Parse the xyDataSeries objects list to a Series objects list. The new series object can be used
   * for xy data charts (like scatter plot)
   *
   * @return Series
   */
  ...
  /**
   * Parse the boxPlotSeries objects list to a Series objects list. The new series object can be
   * used only for BoxPlotSeries
   *
   * @return series
   */
   ...
   * @return List<Object>
   */
  public List<Object> parseXYDataToList(
