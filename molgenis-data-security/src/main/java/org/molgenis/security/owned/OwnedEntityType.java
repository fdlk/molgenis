 ...
 *
 * <p>These entities can only be viewed/updated/deleted by it's creator.
 *
 * <p>Defines one attribute 'ownerUsername', that is the username of the owner. You can extend this
 * EntityType to inherit this behavior.
 */
@Component
