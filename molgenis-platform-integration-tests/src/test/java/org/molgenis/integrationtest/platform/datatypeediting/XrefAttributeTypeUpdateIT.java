...
public class XrefAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  public Object[][] validConversionData() {
    ...
    return new Object[][] {
      {entity, STRING, "1"}, {entity, INT, 1}, {entity, LONG, 1L}, {entity, CATEGORICAL, "label1"}
    };
  }

  /**
   * Valid conversion cases for XREF to: STRING, INT, LONG, CATEGORICAL
   *
  ...
  /**
   * Invalid conversion cases for XREF to: BOOL, TEXT, SCRIPT INT, LONG, DECIMAL, EMAIL, HYPERLINK,
   * HTML, ENUM, DATE, DATE_TIME, MREF, CATEGORICAL_MREF, FILE, COMPOUND, ONE_TO_MANY
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
