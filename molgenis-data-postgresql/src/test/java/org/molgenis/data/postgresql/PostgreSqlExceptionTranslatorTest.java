...
public class PostgreSqlExceptionTranslatorTest {
  ...
  public void translateDependentObjectsStillExistOneDependentTableSingleDependency() {
    ...
    assertEquals(
        e.getMessage(),
        "Cannot delete entity 'myRefEntity' because entity 'myEntity' depends on it.");
  }
  ...
  public void translateForeignKeyViolation() {
    ...
    assertEquals(
        e.getMessage(),
        "Unknown xref value 'myValue' for attribute 'myAttr' of entity 'myEntity'.");
  }
  ...
  public void translateForeignKeyViolationStillReferenced() {
    ...
    assertEquals(
        e.getMessage(),
        "Value 'myValue' for attribute 'myAttr' is referenced by entity 'myEntity'.");
  }
  ...
  public void translateUniqueKeyViolation() {
    ...
    assertEquals(
        e.getMessage(),
        "Duplicate value 'myValue' for unique attribute 'myAttr' from entity 'myEntity'.");
  }
  ...
  public void translateInvalidIntegerExceptionInteger() {
    ...
    MolgenisValidationException e =
        PostgreSqlExceptionTranslator.translateInvalidIntegerException(
            new PSQLException(serverErrorMessage));
    assertEquals(
        e.getMessage(), "Value [str1] of this entity attribute is not of type [INT or LONG].");
  }
  ...
  public void translateInvalidIntegerExceptionDateTime() {
    ...
    MolgenisValidationException e =
        PostgreSqlExceptionTranslator.translateInvalidIntegerException(
            new PSQLException(serverErrorMessage));
    assertEquals(
        e.getMessage(), "Value [str1] of this entity attribute is not of type [DATE_TIME].");
  }
