...
public class EffectStructureConverterTest extends AbstractMolgenisSpringTest {
  ...
  @Autowired EffectStructureConverter effectStructureConverter;
  ...
  public void beforeClass() {
    ...
    Attribute annoAttr =
        attributeFactory.create().setName("ANNO").setDataType(STRING).setParent(INFO);
    ...
    vcfInputEntityType.addAttribute(
        attributeFactory
            .create()
            .setName(EFFECT)
            .setDataType(STRING)
    ...
    annotatedEntityType.addAttribute(
        (attributeFactory.create().setName(FILTER).setDataType(STRING))
            .setDescription(
                "Test that description is not: '"
    ...
    variantEntityType.addAttribute(
        (attributeFactory.create().setName(FILTER).setDataType(STRING))
            .setDescription(
                "Test that description is not: '"
                    + VcfRepository.DEFAULT_ATTRIBUTE_DESCRIPTION
    ...
    effectEntityType.addAttribute(
        attributeFactory
            ...
            .setVisible(false));
    effectEntityType.addAttribute(
        attributeFactory.create().setName("Alt_Allele").setDataType(STRING));
    effectEntityType.addAttribute(
        attributeFactory.create().setName("Gene_Name").setDataType(STRING));
    effectEntityType.addAttribute(
    ...
    effectEntityType.addAttribute(
        attributeFactory.create().setName("Feature_type").setDataType(STRING));
    effectEntityType.addAttribute(
        attributeFactory.create().setName("Feature_ID").setDataType(STRING));
    effectEntityType.addAttribute(
        attributeFactory.create().setName("Transcript_biotype").setDataType(STRING));
    effectEntityType.addAttribute(
        attributeFactory.create().setName("Rank_total").setDataType(STRING));
  }
  ...
  public void testGetDescription() {
    assertEquals(
        effectStructureConverter.getEffectDescription(vcfInputEntityType.getAttribute(EFFECT)),
        "EFFECT annotations: 'Alt_Allele | Gene_Name | Annotation | Putative_impact | Gene_ID | Feature_type | Feature_ID | Transcript_biotype | Rank_total | HGVS_c | HGVS_p | cDNA_position | CDS_position | Protein_position | Distance_to_feature | Errors'");
  }
  ...
  public void testCreateVcfEntityStructure() {
    ...
    Iterator<Entity> result =
        effectStructureConverter.createVcfEntityStructure(
