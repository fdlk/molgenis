...
import static org.molgenis.data.rest.convert.RestTestUtils.BAD_REQUEST;
...
import static org.molgenis.data.rest.convert.RestTestUtils.NOT_FOUND;
...
import static org.molgenis.data.rest.convert.RestTestUtils.UNAUTHORIZED;
...
public class RestControllerIT {
  ...
  public void getWithoutTokenNotAllowed() {
    ...
    response
        ...
        .body(
            "errors.message[0]",
            equalTo(
                "No [COUNT] permission on entity type [Freemarker template] with id [sys_FreemarkerTemplate]"));
    ...
    response
        ...
        .body(
            "errors.message[0]",
            equalTo(
                "No [COUNT] permission on entity type [Script type] with id [sys_scr_ScriptType]"));
    ...
    response
        ...
        .body(
            "errors.message[0]",
            equalTo(
                "No [COUNT] permission on entity type [User authority] with id [sys_sec_UserAuthority]"));
    ...
    response
        ...
        .body(
            "errors.message[0]",
            equalTo(
                "No [COUNT] permission on entity type [Group authority] with id [sys_sec_GroupAuthority]"));
  }
  ...
  public void deleteNonExistingEntity() {
    given()
        ...
        .body(
            "errors.message[0]",
            equalTo("Unknown [File metadata] with id [non-existing-entity_id]"));
  }
  ...
  public void deleteWithoutWritePermissionFails() {
    ...
    given()
        ...
        .body(
            "errors.message[0]",
            equalTo(
                "No [WRITE] permission on entity type [Group authority] with id [sys_sec_GroupAuthority]"));
  }
  ...
  public void afterClass() {
    ...
    // Clean up user
    given()
        .header(X_MOLGENIS_TOKEN, this.adminToken)
        .when()
        .delete("api/v1/sys_sec_User/" + this.testUserId);
  }
}
