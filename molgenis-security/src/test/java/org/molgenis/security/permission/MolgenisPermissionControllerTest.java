...
public class MolgenisPermissionControllerTest {
  ...
  public void hasReadPermissionTrue() {
    ...
    when(permissionService.hasPermissionOnEntityType(entityTypeId, Permission.READ))
        .thenReturn(true);
  ...
  public void hasWritePermissionTrue() {
    String entityTypeId = "entity";
    when(permissionService.hasPermissionOnEntityType(entityTypeId, Permission.WRITE))
        .thenReturn(true);
