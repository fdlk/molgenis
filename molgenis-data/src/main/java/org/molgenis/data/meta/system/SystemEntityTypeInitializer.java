...
public class SystemEntityTypeInitializer {
  ...
  @Autowired
  public SystemEntityTypeInitializer(
      MetaDataService metaDataService,
      RootSystemPackage rootSystemPackage,
      MetaPackage metaPackage,
      GenericDependencyResolver genericDependencyResolver) {
  ...
  private void initialize(
      SystemEntityType systemEntityType, EntityTypeMetadata entityTypeMetaData) {
    ...
    if (!systemEntityType.getPackage().getRootPackage().getId().equals(rootSystemPackage.getId())) {
      throw new RuntimeException(
          format(
              ...
              systemEntityType.getId(), rootSystemPackage.getId()));
    }
  }
