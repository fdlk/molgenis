...
public class MultiAllelicResultFilterTest extends AbstractMolgenisSpringTest {
  ...
  public void filterResultsTest1() {
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result1 =
        filter.filterResults(Collections.singletonList(resultEntity1), entity1, false);
    ...
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result2 =
        filter.filterResults(Collections.singletonList(resultEntity2), entity1, false);
    ...
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result3 =
        filter.filterResults(Collections.singletonList(resultEntity3), entity2, false);
    ...
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result4 =
        filter.filterResults(Collections.singletonList(resultEntity4), entity2, false);
    ...
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result5 =
        filter.filterResults(Collections.singletonList(resultEntity5), entity3, false);
    ...
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result6 =
        filter.filterResults(Collections.singletonList(resultEntity2), entity2, false);
    ...
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result7 =
        filter.filterResults(Collections.singletonList(resultEntity6), entity3, false);
    ...
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            Collections.singletonList(
                attributeFactory.create().setName("annotation").setDataType(STRING)),
            vcfAttributes);
    Optional<Entity> result8 =
        filter.filterResults(Collections.singletonList(resultEntity5), entity1, false);
  ...
  public void filterResultsTest9() {
    ...
    Optional<Entity> result =
        filter.filterResults(Collections.singletonList(resultEntity7), entity7, false);
  ...
  public void filterResultsTest10() {
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            ...
            vcfAttributes);
    Optional<Entity> result =
        filter.filterResults(Collections.singletonList(resultEntity8), entity8, false);
  ...
  public void filterResultsTest11() {
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            ...
            vcfAttributes);
    Optional<Entity> result =
        filter.filterResults(Collections.singletonList(resultEntity9), entity9, false);
  ...
  public void filterResultsTest12() {
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            ...
            vcfAttributes);
    Optional<Entity> result =
        filter.filterResults(Collections.singletonList(resultEntity10), entity10, false);
  ...
  public void filterResultsSourceHasNoRef() {
    MultiAllelicResultFilter filter =
        new MultiAllelicResultFilter(
            ...
            vcfAttributes);
    Optional<Entity> result =
        filter.filterResults(Collections.singletonList(resultEntity10), entityNoRef, false);
  ...
  public void testMultiLineMerge() {
    ...
    multiLineTestEMD.addAttribute(
        attributeFactory.create().setName(customAttrb).setDataType(STRING));
    ...
    Iterable<Entity> multiLineInput =
        Arrays.asList(
            multiLineEntity1,
            multiLineEntity2,
            multiLineEntity3,
    ...
    MultiAllelicResultFilter multiAllelicResultFilter =
        new MultiAllelicResultFilter(
            Lists.newArrayList((multiLineTestEMD.getAttribute(customAttrb))), vcfAttributes);

    Iterable<Entity> expectedResult =
        Arrays.asList(expectedResultEntity1, expectedResultEntity2, expectedResultEntity3);

    Iterable<Entity> actualResult = multiAllelicResultFilter.merge(multiLineInput);

    assertTrue(
        EntityUtils.equals(actualResult.iterator().next(), expectedResult.iterator().next()));
  }
