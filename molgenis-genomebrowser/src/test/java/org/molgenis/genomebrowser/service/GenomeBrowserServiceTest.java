...
public class GenomeBrowserServiceTest {
  ...
  @InjectMocks GenomeBrowserService genomeBrowserService;
  ...
  public void testGetReferenceTracks() {
    ...
    GenomeBrowserAttributes genomeBrowserAttributes =
        getGenomeBrowserAttributes("postion", "chrom", "normal", "mutant");
  ...
  public void testGetReferenceTracksAll() {
    ...
    when(dataService.findAll(
        ...
        .thenReturn(Stream.of(attrs1, attrs2));
  ...
  public static GenomeBrowserAttributes getGenomeBrowserAttributes(
      String pos, String chrom, String ref, String alt) {
