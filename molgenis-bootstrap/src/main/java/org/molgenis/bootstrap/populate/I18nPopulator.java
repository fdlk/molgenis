 ...
 *
 * <p>Only adds new strings, does not update existing ones, because otherwise the ones you have
 * changed using the dataexplorer will be overwritten again on the next startup.
 */
@Component
public class I18nPopulator {
  ...
  public I18nPopulator(
      ...
      List<PropertiesMessageSource> localizationMessageSources,
   ...
   *
   * <p>N.B. If you want to add a namespace with a localization resourcebundle, you need to add a
   * PropertiesMessageSource bean to the spring context for that namespace.
   */
