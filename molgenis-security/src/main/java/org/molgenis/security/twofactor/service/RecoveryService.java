...
/**
 * Service that manages a user's recovery codes. These codes can be used to unlock an account when
 * two factor authentication is enabled and the user loses his/her phone.
 */
public interface RecoveryService {
   ...
   * The code is removed after a successful recovery attempt.
   *
