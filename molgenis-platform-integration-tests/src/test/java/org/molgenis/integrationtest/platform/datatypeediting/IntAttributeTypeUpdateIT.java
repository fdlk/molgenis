...
public class IntAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  /**
   * Valid conversion cases for INT to: STRING, TEXT, DECIMAL, LONG, BOOL, ENUM
   *
  ...
  public void testValidConversion(
      int valueToConvert, AttributeType typeToConvertTo, Object convertedValue) {
  ...
  /**
   * Invalid conversions cases for INT to: XREF, CATEGORICAL, EMAIL, HYPERLINK, HTML, ENUM, DATE,
   * DATE_TIME, MREF, CATEGORICAL_MREF, FILE, COMPOUND, ONE_TO_MANY
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
