 ...
 * An Annotator.
 *
 * <p>Annotators enrich source data with extra attributes.
 *
 * @author fkelpin
 */
public interface Annotator {
  ...
  /**
   * Use this method for the actual annotation process, to ensure that unique identifiers by
   * creating a new set of attributes everytime an annotator us executed
   */
