...
public class RestControllerV2Test extends AbstractMolgenisSpringTest {
  ...
  private static final String HREF_ENTITY_COLLECTION =
      RestControllerV2.BASE_URI + '/' + ENTITY_NAME;
  ...
  public void beforeMethod() throws ParseException {
    ...
    EntityType refEntityType =
        entityTypeFactory
            ...
            .addAttribute(
                attributeFactory.create().setName(REF_ATTR_ID_NAME),
                ROLE_ID,
                ROLE_LABEL,
                ROLE_LOOKUP)
            .addAttribute(attributeFactory.create().setName(REF_ATTR_VALUE_NAME))
            .addAttribute(
                attributeFactory
                    .create()
    ...
    Attribute attrHyperlinkOptional =
  ...
  public void retrieveAtrributeMetaData() {
    ...
    assertEquals(
        restControllerV2.retrieveEntityAttributeMeta(ENTITY_NAME, "id").getDescription(), null);
  }
  ...
  public void retrieveAtrributeMetaDataPost() {
    ...
    assertEquals(
        restControllerV2.retrieveEntityAttributeMetaPost(ENTITY_NAME, "id").getDescription(), null);
  }
  ...
  public void retrieveResourcePartialResponseSubAttribute() throws Exception {
    mockMvc
        .perform(get(HREF_ENTITY_ID).param("attrs", attrXrefName + '(' + REF_ATTR_VALUE_NAME + ')'))
        .andExpect(status().isOk())
        .andExpect(content().contentType(APPLICATION_JSON))
  ...
  public void testCreateEntitiesAttribute() throws Exception {
    ...
    mockMvc
        .perform(
            post(RestControllerV2.BASE_URI + '/' + ATTRIBUTE_META_DATA)
                .content(content)
  ...
  public void testCopyEntityDuplicateEntity() throws Exception {
    ...
    this.assertEqualsErrorMessage(
        resultActions,
        "Operation failed. Duplicate entity: 'org"
            + PACKAGE_SEPARATOR
            + "molgenis"
            + PACKAGE_SEPARATOR
            + "blah"
  ...
  public void testCreateEntitiesExceptions1() throws Exception {
    this.testCreateEntitiesExceptions(
        "entity", "{entities:[]}", "Please provide at least one entity in the entities property.");
  }
  ...
  public void testCreateEntitiesExceptions2() throws Exception {
    this.testCreateEntitiesExceptions(
        "entity",
        this.createMaxPlusOneEntitiesAsTestContent(),
  ...
  public void testUpdateEntitiesExceptions1() throws Exception {
    this.testUpdateEntitiesExceptions(
        "entity", "{entities:[]}", "Please provide at least one entity in the entities property.");
  }
  ...
  public void testSelfRefWithAllAttrsEqualsSelfRefWithoutAttrs() throws Exception {
    MockHttpServletResponse responseWithAttrs =
        mockMvc
            .perform(
                get(RestControllerV2.BASE_URI + "/selfRefEntity/0?attrs=*")
                    .contentType(APPLICATION_JSON))
            .andReturn()
            .getResponse();
    assertEquals(responseWithAttrs.getStatus(), 200);
    MockHttpServletResponse responseWithoutAttrs =
        mockMvc
            .perform(
    ...
    Map<String, Object> lvl1 =
        gson.fromJson(
            responseWithAttrs.getContentAsString(),
  ...
  private void testCreateEntitiesExceptions(String entityTypeId, String content, String message)
      throws Exception {
    ResultActions resultActions =
        mockMvc.perform(
            post(RestControllerV2.BASE_URI + "/" + entityTypeId)
                .content(content)
                .contentType(APPLICATION_JSON));
  ...
  private void testUpdateEntitiesExceptions(String entityTypeId, String content, String message)
      throws Exception {
    ResultActions resultActions =
        mockMvc.perform(
            put(RestControllerV2.BASE_URI + "/" + entityTypeId)
                .content(content)
                .contentType(APPLICATION_JSON));
  ...
  private void testUpdateEntitiesSpecificAttributeExceptions(
      String entityTypeId, String attributeName, String content, String message) throws Exception {
    ResultActions resultActions =
        mockMvc.perform(
            put(RestControllerV2.BASE_URI + "/" + entityTypeId + "/" + attributeName)
                .content(content)
                .contentType(APPLICATION_JSON));
