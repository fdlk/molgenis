...
public class SingleFileLocationCmdLineAnnotatorSettingsConfigurer
    implements CmdLineAnnotatorSettingsConfigurer {
  private final String fileLocationAttributeName;
  private final Entity pluginSettings;

  public SingleFileLocationCmdLineAnnotatorSettingsConfigurer(
      String fileLocationAttributeName, Entity pluginSettings) {
