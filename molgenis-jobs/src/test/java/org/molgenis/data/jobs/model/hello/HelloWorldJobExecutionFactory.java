...
public class HelloWorldJobExecutionFactory
    extends AbstractSystemEntityFactory<
        HelloWorldJobExecution, HelloWorldJobExecutionMetadata, String> {
  @Autowired
  HelloWorldJobExecutionFactory(
      HelloWorldJobExecutionMetadata metaData, EntityPopulator entityPopulator) {
