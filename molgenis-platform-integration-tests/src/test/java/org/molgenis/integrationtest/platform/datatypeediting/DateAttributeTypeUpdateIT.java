...
public class DateAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  public Object[][] validConversionTestCases() {
    return new Object[][] {
      {LocalDate.parse("2016-11-13"), STRING, "2016-11-13"},
      {LocalDate.parse("2016-11-13"), TEXT, "2016-11-13"},
      {
        LocalDate.parse("2016-11-13"),
        DATE_TIME,
  ...
  /**
   * Valid conversion cases for DATE to: STRING, TEXT, DATE_TIME
   *
  ...
  public void testValidConversion(
      LocalDate valueToConvert, AttributeType typeToConvertTo, Object convertedValue)
  ...
  /**
   * Invalid conversion cases for TEXT to: BOOL, INT, LONG, DECIMAL, XREF, CATEGORICAL, SCRIPT,
