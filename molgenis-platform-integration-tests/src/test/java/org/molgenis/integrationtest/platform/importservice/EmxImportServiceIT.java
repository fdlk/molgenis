...
public class EmxImportServiceIT extends ImportServiceIT {
  ...
  @WithMockUser(
    username = USERNAME,
    roles = {ROLE_READ_PACKAGE, ROLE_READ_ENTITY_TYPE, ROLE_READ_ATTRIBUTE}
  )
  @Test
  ...
  private void testDoImportEmxCsvZip() {
    ...
    validateImportReport(
        importReport,
        ImmutableMap.of(CSV_HOSPITAL, 3, CSV_PATIENTS, 3),
  ...
  private void testDoImportEmxTsvZip() {
    ...
    validateImportReport(
        importReport,
        ImmutableMap.of(TSV_HOSPITAL, 3, TSV_PATIENTS, 3),
  ...
  public Iterator<Object[]> doImportEmxAddProvider() {
    ...
    data.add(
        createAddData(
            "it_emx_datatypes.xlsx",
            asList("it", "emx", "datatypes"),
            ImmutableMap.<String, Integer>builder()
                .put("TypeTestRef", 5)
                .put("TypeTest", 38)
                .build(),
            ImmutableSet.of("Person", "TypeTestRef", "Location", "TypeTest"),
            this::verifyItEmxDataTypes));

    data.add(
        createAddData(
            "it_emx_deep_nesting.xlsx",
            asList("it", "deep"),
            ImmutableMap.<String, Integer>builder()
            ...
            ImmutableSet.of(
                ...
                "TestXref1",
                "TestEntity0",
                "advanced_TestEntity1",
                "advanced_p_TestEntity2"),
            this::verifyItEmxDeepNesting));

    data.add(
        createAddData(
            "it_emx_lookup_attribute.xlsx",
            asList("it", "emx", "lookupattribute"),
            ImmutableMap.<String, Integer>builder()
                .put("Ref1", 2)
                .put("Ref2", 2)
                .put("Ref3", 2)
            ...
            this::verifyItEmxLookupAttribute));

    data.add(
        createAddData(
            "it_emx_autoid.xlsx",
            asList("it", "emx", "autoid"),
            ImmutableMap.of("testAutoId", 4),
            ImmutableSet.of("testAutoId"),
            this::verifyItEmxAutoId));

    data.add(
        createAddData(
            "it_emx_onetomany.xlsx",
            asList("it", "emx", "onetomany"),
            ImmutableMap.<String, Integer>builder()
                .put("book", 4)
                .put("author", 2)
                .put("node", 4)
            ...
            this::verifyItEmxOneToMany));

    data.add(
        createAddData(
            "it_emx_self_references.xlsx",
            asList("it", "emx", "selfreferences"),
            ImmutableMap.of("PersonTest", 11),
            ImmutableSet.of("PersonTest"),
            this::verifyItEmxSelfReferences));
  ...
  private void verifyItEmxDeepNesting() {
    verifyFirstAndLastRows(
        "it_deep_advanced_p_TestEntity2", testEntity2FirstRow, testEntity2LastRow);
    verifyFirstAndLastRows(
        "it_deep_TestCategorical1", testCategorical1FirstRow, testCategorical1LastRow);
  ...
  private void verifyItEmxLookupAttribute() {
    ...
    verifyLookupAttributes(
        "it_emx_lookupattribute_Ref2", "lookupTop", "lookupMiddle", "lookupRef2");
  ...
  private void verifyItEmxSelfReferences() {
    verifyFirstAndLastRows(
        "it_emx_selfreferences_PersonTest", personTestFirstRow, personTestLastRow);
  }
  ...
  public void testDoImportAddEmxAsNonSuperuser(
      File file,
      Map<String, Integer> entityCountMap,
  ...
  public void testDoImportAddEmxAsSuperuser(
      File file,
      Map<String, Integer> entityCountMap,
      Set<String> addedEntityTypes,
      Runnable entityValidationMethod) {
  ...
  private void testDoImportAddEmx(
      File file,
      Map<String, Integer> entityCountMap,
      Set<String> addedEntityTypes,
      Runnable entityValidationMethod) {
  ...
  public Iterator<Object[]> doImportEmxAddUpdateProvider() {
    ...
    data.add(
        createUpdateData(
            "it_emx_addupdate.xlsx",
            "it_emx_addupdate-addupdate.xlsx",
            asList("it", "emx", "addupdate"),
            ImmutableMap.<String, Integer>builder().put("TestAddUpdate", 3).build(),
            Collections.emptySet(),
            this::verifyItEmxAddUpdate));

    data.add(
        createUpdateData(
            "it_emx_addAttrToAbstract.xlsx",
            "it_emx_addAttrToAbstract-update.xlsx",
            asList("it", "emx", "addAttrToAbstract"),
            ImmutableMap.<String, Integer>builder().put("Child1", 2).put("Child2", 2).build(),
            Collections.emptySet(),
            this::verifyItEmxAttrToAbstract));
    return data.iterator();
  }
  ...
  public void testDoImportAddUpdateEmxAsNonSuperuser(
      File file,
      File addUpdateFile,
      Map<String, Integer> entityCountMap,
      Set<String> addedEntityTypes,
      Runnable entityValidationMethod) {
    executeAddUpdateOrUpdateTest(
        file, addUpdateFile, entityCountMap, addedEntityTypes, entityValidationMethod);
  }
  ...
  public void testDoImportAddUpdateEmxAsSuperuser(
      File file,
      File addUpdateFile,
      Map<String, Integer> entityCountMap,
      Set<String> addedEntityTypes,
  ...
  private void executeAddUpdateOrUpdateTest(
      File file,
      File addUpdateFile,
      Map<String, Integer> entityCountMap,
      Set<String> addedEntityTypes,
      Runnable entityValidationMethod) {
    FileRepositoryCollection addRepoCollection =
        fileRepositoryCollectionFactory.createFileRepositoryCollection(file);
    ...
    FileRepositoryCollection addUpdateRepoCollection =
        fileRepositoryCollectionFactory.createFileRepositoryCollection(addUpdateFile);
    ImportService addUpdateImportService =
        importServiceFactory.getImportService(addUpdateFile, addUpdateRepoCollection);
    EntityImportReport importReport =
        addUpdateImportService.doImport(
            addUpdateRepoCollection, ADD_UPDATE_EXISTING, PACKAGE_DEFAULT);
  ...
  public Iterator<Object[]> doImportEmxUpdateProvider() {
    ...
    data.add(
        createUpdateData(
            "it_emx_update.xlsx",
            "it_emx_update-update.xlsx",
            asList("it", "emx", "update"),
            ImmutableMap.<String, Integer>builder().put("TestUpdate", 2).build(),
            Collections.emptySet(),
  ...
  public void testDoImportUpdateEmxAsNonSuperuser(
      File file,
      File updateFile,
      Map<String, Integer> entityCountMap,
      Set<String> addedEntityTypes,
      Runnable entityValidationMethod) {
    executeAddUpdateOrUpdateTest(
        file, updateFile, entityCountMap, addedEntityTypes, entityValidationMethod);
  }
  ...
  public void testDoImportUpdateEmxAsSuperuser(
      File file,
      File updateFile,
      Map<String, Integer> entityCountMap,
      Set<String> addedEntityTypes,
  ...
  private static Object[] createAddData(
      String fileName,
      List<String> packageTokens,
      Map<String, Integer> entityCountMap,
    ...
    Set<String> entityTypeFullyQualifiedNames =
        entityTypeNames
            ...
            .collect(toSet());
    return new Object[] {
      file, entityTypeCountMap, entityTypeFullyQualifiedNames, entityValidationMethod
    };
  }

  private static Object[] createUpdateData(
      String fileName,
    ...
    Set<String> entityTypeFullyQualifiedNames =
        entityTypeNames
            ...
            .collect(toSet());
    return new Object[] {
      addFile, updateFile, entityTypeCountMap, entityTypeFullyQualifiedNames, entityValidationMethod
    };
  }
