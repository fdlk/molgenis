...
public class MrefAttributeTypeUpdateIT extends AbstractAttributeTypeUpdateIT {
  ...
  /**
   * Valid conversion cases for MREF to: CATEGORICAL_MREF
   *
  ...
  /**
   * Invalid conversion cases for MREF to: BOOL, STRING, TEXT, SCRIPT INT, LONG, DECIMAL, XREF,
   * CATEGORICAL, EMAIL, HYPERLINK, HTML, ENUM, DATE, DATE_TIME, FILE, COMPOUND, ONE_TO_MANY
   *
   * @param valueToConvert The value that will be converted
   * @param typeToConvertTo The type to convert to
