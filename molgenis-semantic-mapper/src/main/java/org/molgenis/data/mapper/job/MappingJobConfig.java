...
public class MappingJobConfig {
  ...
  public ScheduledJobType mappingJobType() {
    ScheduledJobType result =
        scheduledJobTypeFactory.create(MappingJobExecutionMetadata.MAPPING_JOB_TYPE);
    ...
    result.setSchema(
        gson.toJson(
            of(
                ...
                of(
                    "mappingProjectId",
                    of("type", "string", "description", "The ID of the mapping project"),
                    "targetEntityTypeId",
                    of(
                        "type",
                        "string",
                ...
                "required",
                ImmutableList.of("mappingProjectId", "targetEntityTypeId"))));
