  ...
  private static Object toScriptEngineValue(Entity entity, Attribute attr) {
    ...
    switch (attrType) {
      ...
      case XREF:
        ...
        value =
            xrefEntity != null
                ? toScriptEngineValue(xrefEntity, xrefEntity.getEntityType().getIdAttribute())
                : null;
        break;
      ...
      case ONE_TO_MANY:
        ...
        value =
            stream(mrefEntities.spliterator(), false)
                .map(
                    mrefEntity ->
                        toScriptEngineValue(
                            mrefEntity, mrefEntity.getEntityType().getIdAttribute()))
                .collect(toList());
        break;
      case DATE:
