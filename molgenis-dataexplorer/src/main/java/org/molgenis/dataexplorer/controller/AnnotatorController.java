...
public class AnnotatorController {
  ...
  @ResponseBody
  public Map<String, Map<String, Object>> getMapOfAvailableAnnotators(
      @RequestBody String dataSetName) {
    Map<String, Map<String, Object>> annotatorMap = setMapOfAnnotators(dataSetName);
    return annotatorMap;
  }

  /**
   * Annotates an entity based on selected entity and selected annotators. Creates a copy of the
   * entity dataset if option is ticked by the user.
   *
  ...
  private Map<String, Map<String, Object>> setMapOfAnnotators(String dataSetName) {
    ...
    if (dataSetName != null) {
      ...
      for (RepositoryAnnotator annotator : annotationService.getAllAnnotators()) {
        ...
        String settingsEntityName =
            PACKAGE_SETTINGS + PACKAGE_SEPARATOR + annotator.getInfo().getCode();
        map.put(
            "showSettingsButton",
