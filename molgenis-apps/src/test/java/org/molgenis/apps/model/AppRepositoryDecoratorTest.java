...
public class AppRepositoryDecoratorTest extends AbstractMockitoTest {
  ...
  @Mock private Repository<App> delegateRepository;
  ...
  @Test(
    ...
    expectedExceptionsMessageRegExp = "'app-invalid.zip' is not a valid zip file."
  )
  ...
  private App getMockApp(String id, boolean isActive, String resourceFilename) {
    ...
    if (resourceFilename != null) {
      ...
      when(fileStore.getFile(resourceFilename))
          .thenReturn(getFile(getClass(), '/' + resourceFilename));
