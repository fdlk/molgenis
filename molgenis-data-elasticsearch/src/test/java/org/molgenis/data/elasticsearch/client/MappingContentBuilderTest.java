...
public class MappingContentBuilderTest {
  ...
  private static final String JSON_TEXT =
      "{\"_source\":{\"enabled\":false},\"properties\":{\"field\":{\"type\":\"text\",\"norms\":true,\"fields\":{\"raw\":{\"type\":\"keyword\",\"index\":true}}}}}";

  private static final String JSON_TEXT_NGRAM =
      "{\"_source\":{\"enabled\":false},\"properties\":{\"field\":{\"type\":\"text\",\"norms\":true,\"fields\":{\"raw\":{\"type\":\"keyword\",\"index\":true},\"ngram\":{\"type\":\"text\",\"analyzer\":\"ngram_analyzer\"}}}}}";
