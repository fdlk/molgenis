...
public class ClinvarAnnotator implements AnnotatorConfig {
  ...
  @Autowired private Entity clinvarAnnotatorSettings;
  ...
  public void init() {
    ...
    ClinvarMultiAllelicResultFilter clinvarMultiAllelicResultFilter =
        new ClinvarMultiAllelicResultFilter(vcfAttributes);
    EntityAnnotator entityAnnotator =
        new AbstractAnnotator(
            ...
            new SingleFileLocationCmdLineAnnotatorSettingsConfigurer(
                CLINVAR_LOCATION, clinvarAnnotatorSettings)) {
          @Override
    ...
    return new ResourceImpl(
      ...
      public RepositoryFactory getRepositoryFactory() {
        return new TabixVcfRepositoryFactory(
            CLINVAR_TABIX_RESOURCE, vcfAttributes, entityTypeFactory, attributeFactory);
      }
    };
  }
}
