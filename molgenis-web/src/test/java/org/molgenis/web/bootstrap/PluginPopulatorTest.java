...
public class PluginPopulatorTest extends AbstractMockitoTest {
  ...
  public void testPopulate() throws Exception {
    PluginController pluginController0 =
        when(mock(PluginController.class).getId()).thenReturn("newPlugin").getMock();
    PluginController pluginController1 =
        when(mock(PluginController.class).getId()).thenReturn("changedPlugin").getMock();
    ...
    Plugin existingChangedPlugin =
        when(mock(Plugin.class).getId()).thenReturn("changedPlugin").getMock();
